...
class EdenAllianceRewardTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EdenAllianceRewardTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEdenAllianceRewardTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EdenAllianceReward import EdenAllianceReward
            obj = EdenAllianceReward()
...
def EdenAllianceRewardTableStart(builder):
...
def End(builder):
    return EdenAllianceRewardTableEnd(builder)
