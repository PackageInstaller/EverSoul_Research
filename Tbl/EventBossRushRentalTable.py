...
class EventBossRushRentalTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventBossRushRentalTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventBossRushRentalTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventBossRushRental import EventBossRushRental
            obj = EventBossRushRental()
...
def EventBossRushRentalTableStart(builder):
...
def End(builder):
    return EventBossRushRentalTableEnd(builder)
