...
class EventChallengeStageRentalTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventChallengeStageRentalTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventChallengeStageRentalTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventChallengeStageRental import EventChallengeStageRental
            obj = EventChallengeStageRental()
...
def EventChallengeStageRentalTableStart(builder):
...
def End(builder):
    return EventChallengeStageRentalTableEnd(builder)
