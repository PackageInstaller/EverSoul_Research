...
class EdenAllianceTierTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EdenAllianceTierTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEdenAllianceTierTable(cls, buf, offset=0):
    ...
    def EdenAllianceTiers(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EdenAllianceTier import EdenAllianceTier
            obj = EdenAllianceTier()
...
def EdenAllianceTierTableStart(builder):
...
def End(builder):
    return EdenAllianceTierTableEnd(builder)
