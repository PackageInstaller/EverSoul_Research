...
class TowerExtendStageTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = TowerExtendStageTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsTowerExtendStageTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.TowerExtendStage import TowerExtendStage
            obj = TowerExtendStage()
...
def TowerExtendStageTableStart(builder):
...
def End(builder):
    return TowerExtendStageTableEnd(builder)
