...
class EventDoubleStageSettingTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventDoubleStageSettingTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventDoubleStageSettingTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventDoubleStageSetting import EventDoubleStageSetting
            obj = EventDoubleStageSetting()
...
def EventDoubleStageSettingTableStart(builder):
...
def End(builder):
    return EventDoubleStageSettingTableEnd(builder)
