...
class VistaBonusTable(object):
    ...
    @classmethod
    def GetRootAsVistaBonusTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.VistaBonus import VistaBonus
            obj = VistaBonus()
...
def VistaBonusTableStart(builder):
...
def End(builder):
    return VistaBonusTableEnd(builder)
