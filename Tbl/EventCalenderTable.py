...
class EventCalenderTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventCalenderTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventCalenderTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventCalender import EventCalender
            obj = EventCalender()
...
def EventCalenderTableStart(builder):
...
def End(builder):
    return EventCalenderTableEnd(builder)
