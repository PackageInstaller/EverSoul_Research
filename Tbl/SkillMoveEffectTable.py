...
class SkillMoveEffectTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = SkillMoveEffectTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsSkillMoveEffectTable(cls, buf, offset=0):
    ...
    def SkillMoveEffects(self, j):
        ...
        if o != 0:
            ...
            from Tbl.SkillMoveEffect import SkillMoveEffect
            obj = SkillMoveEffect()
...
def SkillMoveEffectTableStart(builder):
...
def End(builder):
    return SkillMoveEffectTableEnd(builder)
