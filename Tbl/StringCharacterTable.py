...
class StringCharacterTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = StringCharacterTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsStringCharacterTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.StringCharacter import StringCharacter
            obj = StringCharacter()
...
def StringCharacterTableStart(builder):
...
def End(builder):
    return StringCharacterTableEnd(builder)
