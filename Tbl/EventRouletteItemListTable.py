...
class EventRouletteItemListTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventRouletteItemListTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventRouletteItemListTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventRouletteItemList import EventRouletteItemList
            obj = EventRouletteItemList()
...
def EventRouletteItemListTableStart(builder):
...
def End(builder):
    return EventRouletteItemListTableEnd(builder)
