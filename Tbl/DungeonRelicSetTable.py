...
class DungeonRelicSetTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = DungeonRelicSetTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsDungeonRelicSetTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.DungeonRelicSet import DungeonRelicSet
            obj = DungeonRelicSet()
...
def DungeonRelicSetTableStart(builder):
...
def End(builder):
    return DungeonRelicSetTableEnd(builder)
