...
class ItemBoxTable(object):
    ...
    @classmethod
    def GetRootAsItemBoxTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.ItemBox import ItemBox
            obj = ItemBox()
...
def End(builder):
    return ItemBoxTableEnd(builder)
