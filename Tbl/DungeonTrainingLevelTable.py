...
class DungeonTrainingLevelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = DungeonTrainingLevelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsDungeonTrainingLevelTable(cls, buf, offset=0):
    ...
    def DungeonTrainingLevels(self, j):
        ...
        if o != 0:
            ...
            from Tbl.DungeonTrainingLevel import DungeonTrainingLevel
            obj = DungeonTrainingLevel()
...
def DungeonTrainingLevelTableStart(builder):
...
def End(builder):
    return DungeonTrainingLevelTableEnd(builder)
