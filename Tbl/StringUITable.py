...
class StringUITable(object):
    ...
    @classmethod
    def GetRootAsStringUITable(cls, buf, offset=0):
    ...
    def StringUis(self, j):
        ...
        if o != 0:
            ...
            from Tbl.StringUI import StringUI
            obj = StringUI()
...
def StringUITableStart(builder):
...
def End(builder):
    return StringUITableEnd(builder)
