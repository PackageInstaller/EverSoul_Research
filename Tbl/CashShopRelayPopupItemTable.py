...
class CashShopRelayPopupItemTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = CashShopRelayPopupItemTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsCashShopRelayPopupItemTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.CashShopRelayPopupItem import CashShopRelayPopupItem
            obj = CashShopRelayPopupItem()
...
def CashShopRelayPopupItemTableStart(builder):
...
def End(builder):
    return CashShopRelayPopupItemTableEnd(builder)
