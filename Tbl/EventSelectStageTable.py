...
class EventSelectStageTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventSelectStageTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventSelectStageTable(cls, buf, offset=0):
    ...
    def EventSelectStages(self, j):
        ...
        if o != 0:
            ...
            from Tbl.EventSelectStage import EventSelectStage
            obj = EventSelectStage()
...
def EventSelectStageTableStart(builder):
...
def End(builder):
    return EventSelectStageTableEnd(builder)
