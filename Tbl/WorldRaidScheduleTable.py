...
class WorldRaidScheduleTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = WorldRaidScheduleTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsWorldRaidScheduleTable(cls, buf, offset=0):
    ...
    def Json(self, j):
        ...
        if o != 0:
            ...
            from Tbl.WorldRaidSchedule import WorldRaidSchedule
            obj = WorldRaidSchedule()
...
def WorldRaidScheduleTableStart(builder):
...
def End(builder):
    return WorldRaidScheduleTableEnd(builder)
