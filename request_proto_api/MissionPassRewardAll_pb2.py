...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MISSIONPASSREWARDALL']._serialized_start=38
  _globals['_MISSIONPASSREWARDALL']._serialized_end=213
