...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DUNGEONRESTART']._serialized_end=81
  _globals['_SDUNGEON']._serialized_start=84
  _globals['_SDUNGEON']._serialized_end=610
