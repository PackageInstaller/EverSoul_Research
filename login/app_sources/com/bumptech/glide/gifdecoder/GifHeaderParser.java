...
public class GifHeaderParser {
    ...
    public GifHeader parseHeader() {
        if (this.rawData == null) {
            throw new IllegalStateException(y.֬ڱܱײٮ(-1159276559));
        }
        if (err()) {
            return this.header;
        }
        ...
        while (!z && !err() && this.header.frameCount <= i) {
            ...
            if (read == 33) {
                ...
                if (read2 == 1) {
                    ...
                    if (sb.toString().equals(y.٬ݯح׭٩(576015886))) {
                        readNetscapeExt();
                    } else {
                        skip();
                    }
    ...
    private void readBitmap() {
        this.header.currentFrame.f152ix = readShort();
        this.header.currentFrame.f153iy = readShort();
        this.header.currentFrame.f151iw = readShort();
        this.header.currentFrame.f150ih = readShort();
        int read = read();
    ...
    private void readHeader() {
        ...
        if (!sb.toString().startsWith(y.٬ݯح׭٩(576016022))) {
            this.header.status = 1;
            return;
        }
        readLSD();
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            String str = y.ݮڮֲڭܩ(-628966580);
            if (Log.isLoggable(str, 3)) {
                Log.d(str, y.ٴسسݬߨ(1392937330), e);
            }
            this.header.status = 1;
        }
        return iArr;
    ...
    private void readBlock() {
        ...
        while (true) {
            try {
                ...
                String str = y.ݮڮֲڭܩ(-628966580);
                if (Log.isLoggable(str, 3)) {
                    Log.d(str, y.ٴسسݬߨ(1392939002) + i + y.ݬֲ֮ܲت(1513071607) + i2 + y.ۮڭڭܬި(862118283) + this.blockSize, e);
                }
                this.header.status = 1;
                return;
            }
