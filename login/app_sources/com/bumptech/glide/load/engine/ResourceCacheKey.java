...
final class ResourceCacheKey implements Key {
    ...
    public String toString() {
        return y.ٲٴݴ״ٰ(1781778216) + this.sourceKey + y.٬ݯح׭٩(576006110) + this.signature + y.ݬֲ֮ܲت(1513090775) + this.width + y.ۮڭڭܬި(862104747) + this.height + y.ٲٴݴ״ٰ(1781777968) + this.decodedResourceClass + y.٬ݯح׭٩(576003550) + this.transformation + y.ٴسسݬߨ(1392958162) + this.options + '}';
    }
}
