...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    private static final boolean VERBOSE_IS_LOGGABLE = Log.isLoggable(y.ٴسسݬߨ(1392955330), 2);
    ...
    private <R> LoadStatus waitForExistingOrStartNewJob(GlideContext glideContext, Object obj, Key key, int i, int i2, Class<?> cls, Class<R> cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, Options options, boolean z3, boolean z4, boolean z5, boolean z6, ResourceCallback resourceCallback, Executor executor, EngineKey engineKey, long j) {
        ...
        if (engineJob != null) {
            ...
            if (VERBOSE_IS_LOGGABLE) {
                logWithTimeAndKey(y.ݬֲ֮ܲت(1513087599), j, engineKey);
            }
        ...
        build.start(build2);
        if (VERBOSE_IS_LOGGABLE) {
            logWithTimeAndKey(y.٬ݯح׭٩(575999622), j, engineKey);
        }
    ...
    private EngineResource<?> loadFromMemory(EngineKey engineKey, boolean z, long j) {
        ...
        if (loadFromActiveResources != null) {
            if (VERBOSE_IS_LOGGABLE) {
                logWithTimeAndKey(y.ۮڭڭܬި(862103275), j, engineKey);
            }
        ...
        if (VERBOSE_IS_LOGGABLE) {
            logWithTimeAndKey(y.ݬֲ֮ܲت(1513087631), j, engineKey);
        }
    ...
    private static void logWithTimeAndKey(String str, long j, Key key) {
        Log.v(TAG, str + y.ٲٴݴ״ٰ(1781787080) + LogTime.getElapsedMillis(j) + "ms, key: " + key);
    }
    ...
    public void release(Resource<?> resource) {
        ...
        throw new IllegalArgumentException(y.ݮڮֲڭܩ(-628949228));
    }
    ...
    public class LoadStatus {
        ...
        /* renamed from: cb */
        private final ResourceCallback f156cb;
        private final EngineJob<?> engineJob;

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob) {
            this.f156cb = resourceCallback;
        ...
        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f156cb);
            }
        }
    }
