...
public class ResourceDrawableDecoder implements ResourceDecoder<Uri, Drawable> {
    ...
    private Context findContextForPackage(Uri uri, String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(y.ٴسسݬߨ(1393013578) + uri, e);
        }
    }
    ...
    private int findResourceIdFromUri(Context context, Uri uri) {
        ...
        throw new IllegalArgumentException(y.֬ڱܱײٮ(-1159212591) + uri);
    }
    ...
    private int findResourceIdFromTypeAndNameResourceUri(Context context, Uri uri) {
        ...
        if (identifier == 0) {
            identifier = Resources.getSystem().getIdentifier(str2, str, y.ٴسسݬߨ(1392813258));
        }
        if (identifier != 0) {
            return identifier;
        }
        throw new IllegalArgumentException(y.֬ڱܱײٮ(-1159212807) + uri);
    }
    ...
    private int findResourceIdFromResourceIdUri(Uri uri) {
        try {
            ...
            throw new IllegalArgumentException(y.֬ڱܱײٮ(-1159212591) + uri, e);
        }
    }
}
