...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    public static final Option<Long> TARGET_FRAME = Option.disk(y.ٴسسݬߨ(1393014522), -1L, new Option.CacheKeyUpdater<Long>() { // from class: com.bumptech.glide.load.resource.bitmap.VideoDecoder.1
    ...
    public static final Option<Integer> FRAME_OPTION = Option.disk(y.ݮڮֲڭܩ(-628915060), 2, new Option.CacheKeyUpdater<Integer>() { // from class: com.bumptech.glide.load.resource.bitmap.VideoDecoder.2
