...
public class NetworkImageView extends ImageView {
    ...
    class C07241 implements ImageLoader.ImageListener {
        ...
        public void onResponse(final ImageLoader.ImageContainer imageContainer, boolean z) {
            if (z && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new Runnable() { // from class: com.android.volley.toolbox.NetworkImageView.1.1
                    ...
                    public void run() {
                        C07241.this.onResponse(imageContainer, false);
                    }
                });
                return;
            }
    ...
    void loadImageIfNecessary(boolean z) {
        ...
        this.mImageContainer = this.mImageLoader.get(this.mUrl, new C07241(z), width, z3 ? 0 : height, scaleType);
    }
