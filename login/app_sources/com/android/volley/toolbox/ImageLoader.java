...
public class ImageLoader {
    ...
    private static String getCacheKey(String str, int i, int i2, ImageView.ScaleType scaleType) {
        return new StringBuilder(str.length() + 12).append(y.ٲٴݴ״ٰ(1781551128)).append(i).append(y.ݮڮֲڭܩ(-629048452)).append(i2).append("#S").append(scaleType.ordinal()).append(str).toString();
    }
    ...
    private void throwIfNotOnMainThread() {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            throw new IllegalStateException(y.ٴسسݬߨ(1392856850));
        }
    }
