...
public final class KakaoGame2ndPwErrorViewBinding implements ViewBinding {
    ...
    private KakaoGame2ndPwErrorViewBinding(RelativeLayout relativeLayout, NotoSansTextView notoSansTextView, NotoSansTextView notoSansTextView2, NotoSansTextView notoSansTextView3, RelativeLayout relativeLayout2, NotoSansButton notoSansButton, RelativeLayout relativeLayout3) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static KakaoGame2ndPwErrorViewBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static KakaoGame2ndPwErrorViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2558R.layout.kakao_game_2nd_pw_error_view, viewGroup, false);
        if (z) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static KakaoGame2ndPwErrorViewBinding bind(View view) {
                ...
                if (notoSansTextView3 != null) {
                    ...
                    if (relativeLayout != null) {
                        ...
                        if (notoSansButton != null) {
                            ...
                            return new KakaoGame2ndPwErrorViewBinding(relativeLayout2, notoSansTextView, notoSansTextView2, notoSansTextView3, relativeLayout, notoSansButton, relativeLayout2);
                        }
                    }
                }
            }
