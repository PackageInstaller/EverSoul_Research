...
public final class ZinnySdkCafeDialogWebKakaoBinding implements ViewBinding {
    ...
    private ZinnySdkCafeDialogWebKakaoBinding(RelativeLayout relativeLayout, ImageView imageView, RelativeLayout relativeLayout2, LinearLayout linearLayout, WebView webView, FrameLayout frameLayout, SwipeRefreshLayout swipeRefreshLayout, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, ImageView imageView2, FrameLayout frameLayout2) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static ZinnySdkCafeDialogWebKakaoBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static ZinnySdkCafeDialogWebKakaoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C2382R.layout.zinny_sdk_cafe_dialog_web_kakao, viewGroup, false);
        if (z) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static ZinnySdkCafeDialogWebKakaoBinding bind(View view) {
        int i = C2382R.id.zinny_sdk_dialog_cafe_logo;
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(view, i);
        if (imageView != null) {
            i = C2382R.id.zinny_sdk_dialog_web;
                                ...
                                if (relativeLayout3 != null) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (frameLayout2 != null) {
                                            return new ZinnySdkCafeDialogWebKakaoBinding(relativeLayout2, imageView, relativeLayout, linearLayout, webView, frameLayout, swipeRefreshLayout, relativeLayout2, relativeLayout3, imageView2, frameLayout2);
                                        }
                                    }
                                }
                            }
