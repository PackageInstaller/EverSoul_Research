...
@DebugMetadata(m854c = "com.kakaogame.log.SDKLogManager$uploadLogFiles$1", m855f = "SDKLogManager.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
/* loaded from: classes3.dex */
final class SDKLogManager$uploadLogFiles$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    SDKLogManager$uploadLogFiles$1(SDKLogManager sDKLogManager, Context context, Continuation<? super SDKLogManager$uploadLogFiles$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SDKLogManager$uploadLogFiles$1(this.this$0, this.$context, continuation);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SDKLogManager$uploadLogFiles$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            ...
            if (file.exists()) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    Log.v(str, "upload result: " + uploadFile);
                    if (uploadFile == 200) {
                        listFiles[i].delete();
                    }
                }
            ...
            Log.e(str, y.֬ڱܱײٮ(-1158701903) + e);
        }
