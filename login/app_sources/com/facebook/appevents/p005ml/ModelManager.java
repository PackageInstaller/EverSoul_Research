package com.facebook.appevents.p005ml;
...
public final class ModelManager {
    ...
    /* compiled from: ModelManager.kt */
    @Metadata(m838d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004J\u0006\u0010\u0005\u001a\u00020\u0004j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, m839d2 = {"Lcom/facebook/appevents/ml/ModelManager$Task;", "", "(Ljava/lang/String;I)V", "toKey", "", "toUseCase", "MTML_INTEGRITY_DETECT", "MTML_APP_EVENT_PREDICTION", "facebook-core_release"}, m840k = 1, m841mv = {1, 5, 1}, m843xi = 48)
    public enum Task {
        ...
        try {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ModelManager.m1027enable$lambda0();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ModelManager.class);
    ...
    */
    public static final void m1027enable$lambda0() {
        /*
            java.lang.String r0 = "model_request_timestamp"
            java.lang.String r1 = "models"
            java.lang.Class<com.facebook.appevents.ml.ModelManager> r2 = com.facebook.appevents.p005ml.ModelManager.class
        ...
        L39:
            ...
            if (r4 == 0) goto L57
            com.facebook.appevents.ml.ModelManager r4 = com.facebook.appevents.p005ml.ModelManager.INSTANCE     // Catch: java.lang.Throwable -> L80 java.lang.Exception -> L84
        ...
        L77:
            com.facebook.appevents.ml.ModelManager r0 = com.facebook.appevents.p005ml.ModelManager.INSTANCE     // Catch: java.lang.Throwable -> L80 java.lang.Exception -> L84
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.p005ml.ModelManager.m1027enable$lambda0():void");
    }
                ...
                if (Intrinsics.areEqual(key, Task.MTML_APP_EVENT_PREDICTION.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.SuggestedEvents) && isLocaleEnglish()) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda1
                            ...
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m1028enableMTML$lambda1();
                            }
                        }));
                    }
                    str = assetUri;
                ...
                if (Intrinsics.areEqual(key, Task.MTML_INTEGRITY_DETECT.toUseCase())) {
                    ...
                    if (FeatureManager.isEnabled(FeatureManager.Feature.IntelligentIntegrity)) {
                        arrayList.add(value.setOnPostExecute(new Runnable() { // from class: com.facebook.appevents.ml.ModelManager$$ExternalSyntheticLambda2
                            ...
                            @Override // java.lang.Runnable
                            public final void run() {
                                ModelManager.m1029enableMTML$lambda2();
                            }
                        }));
                    }
                }
    ...
    public static final void m1028enableMTML$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final void m1029enableMTML$lambda2() {
        if (CrashShieldHandler.isObjectCrashing(ModelManager.class)) {
            return;
        }
        try {
    ...
    public static final class TaskHandler {
        ...
        public static final class Companion {
            ...
            public final void execute(TaskHandler master, final List<TaskHandler> slaves) {
                ...
                download(master.getAssetUri(), master.getUseCase() + '_' + master.getVersionId(), new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager$TaskHandler$Companion$$ExternalSyntheticLambda0
                    ...
                    public final void onComplete(File file) {
                        ModelManager.TaskHandler.Companion.m1031execute$lambda1(slaves, file);
                    }
                });
            }
            ...
            public static final void m1031execute$lambda1(List slaves, File file) {
                Intrinsics.checkNotNullParameter(slaves, "$slaves");
                    ...
                    while (it.hasNext()) {
                        ...
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), taskHandler.getUseCase() + '_' + taskHandler.getVersionId() + "_rule", new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager$TaskHandler$Companion$$ExternalSyntheticLambda1
                            ...
                            public final void onComplete(File file2) {
                                ModelManager.TaskHandler.Companion.m1032execute$lambda1$lambda0(ModelManager.TaskHandler.this, build, file2);
                            }
                        });
                    }
                }
            ...
            public static final void m1032execute$lambda1$lambda0(TaskHandler slave, Model model, File file) {
