...
public final class OnDeviceProcessingManager {
    ...
    */
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.ondeviceprocessing.OnDeviceProcessingManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    OnDeviceProcessingManager.m1034sendInstallEventAsync$lambda0(applicationContext, preferencesName, applicationId);
                }
            });
        } catch (Throwable th) {
    ...
    public static final void m1034sendInstallEventAsync$lambda0(Context context, String str, String str2) {
        if (CrashShieldHandler.isObjectCrashing(OnDeviceProcessingManager.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            if (INSTANCE.isEventEligibleForOnDeviceProcessing(event)) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.ondeviceprocessing.OnDeviceProcessingManager$$ExternalSyntheticLambda1
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        OnDeviceProcessingManager.m1033sendCustomEventAsync$lambda1(applicationId, event);
                    }
                });
            }
        } catch (Throwable th) {
    ...
    public static final void m1033sendCustomEventAsync$lambda1(String applicationId, AppEvent event) {
        if (CrashShieldHandler.isObjectCrashing(OnDeviceProcessingManager.class)) {
            return;
        }
        try {
