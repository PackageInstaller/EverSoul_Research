...
public final class AppEventQueue {
    ...
    private static final Runnable flushRunnable = new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda5
        ...
        public final void run() {
            AppEventQueue.m971flushRunnable$lambda0();
        }
    };
    ...
    public static final void m971flushRunnable$lambda0() {
    ...
    public static final void persistToDisk() {
        ...
        try {
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda3
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m973persistToDisk$lambda1();
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m973persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(final FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda2
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m970flush$lambda2(FlushReason.this);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m970flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void add(final AccessTokenAppIdPair accessTokenAppId, final AppEvent appEvent) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda4
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m968add$lambda3(AccessTokenAppIdPair.this, appEvent);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventQueue.class);
    ...
    public static final void m968add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            newPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda1
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m969buildRequestForSession$lambda4(AccessTokenAppIdPair.this, newPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m969buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            if (flushResult == FlushResult.NO_CONNECTIVITY) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.AppEventQueue$$ExternalSyntheticLambda0
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventQueue.m972handleResponse$lambda5(AccessTokenAppIdPair.this, appEvents);
                    }
                });
            }
    ...
    public static final void m972handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
