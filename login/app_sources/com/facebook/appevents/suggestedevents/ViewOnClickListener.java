...
public final class ViewOnClickListener implements View.OnClickListener {
        ...
        try {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewOnClickListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ViewOnClickListener.m1037predictAndProcess$lambda0(viewData, buttonText, this, pathID);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final void m1037predictAndProcess$lambda0(JSONObject viewData, String buttonText, ViewOnClickListener this$0, String pathID) {
        if (CrashShieldHandler.isObjectCrashing(ViewOnClickListener.class)) {
            return;
        }
        try {
    ...
    public static final class Companion {
        ...
        public final boolean queryHistoryAndProcess(String pathID, final String buttonText) {
            ...
            Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.suggestedevents.ViewOnClickListener$Companion$$ExternalSyntheticLambda0
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    ViewOnClickListener.Companion.m1038queryHistoryAndProcess$lambda0(queryEvent, buttonText);
                }
            });
            return true;
        }
        ...
        public static final void m1038queryHistoryAndProcess$lambda0(String queriedEvent, String buttonText) {
