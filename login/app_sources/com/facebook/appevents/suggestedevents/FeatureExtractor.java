...
public final class FeatureExtractor {
    ...
    public static final void initialize(File file) {
        ...
        try {
            try {
                ...
                languageInfo = MapsKt.mapOf(TuplesKt.m846to(ViewHierarchyConstants.ENGLISH, AppEventsConstants.EVENT_PARAM_VALUE_YES), TuplesKt.m846to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m846to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m846to(ViewHierarchyConstants.JAPANESE, "4"));
                eventInfo = MapsKt.mapOf(TuplesKt.m846to(ViewHierarchyConstants.VIEW_CONTENT, AppEventsConstants.EVENT_PARAM_VALUE_NO), TuplesKt.m846to(ViewHierarchyConstants.SEARCH, AppEventsConstants.EVENT_PARAM_VALUE_YES), TuplesKt.m846to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m846to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m846to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.m846to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m846to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m846to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m846to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                textTypeInfo = MapsKt.mapOf(TuplesKt.m846to(ViewHierarchyConstants.BUTTON_TEXT, AppEventsConstants.EVENT_PARAM_VALUE_YES), TuplesKt.m846to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m846to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m846to(ViewHierarchyConstants.BUTTON_ID, "4"));
                initialized = true;
    ...
    private final float[] parseFeatures(JSONObject node) {
        ...
        try {
            ...
            if (matchIndicators(new String[]{"complete", Base2ndPWViewData.KEY_CONFIRM, "done", "submit"}, new String[]{lowerCase})) {
    ...
    private final void updateHintAndTextRecursively(JSONObject view, StringBuilder textSB, StringBuilder hintSB) {
        ...
        try {
            ...
            if (lowerCase.length() > 0) {
                textSB.append(lowerCase).append(StringUtils.SPACE);
            }
            if (lowerCase2.length() <= 0) {
                z = false;
            }
            if (z) {
                hintSB.append(lowerCase2).append(StringUtils.SPACE);
            }
