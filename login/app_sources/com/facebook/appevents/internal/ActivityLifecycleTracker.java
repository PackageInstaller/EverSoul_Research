...
public final class ActivityLifecycleTracker {
        ...
        if (tracking.compareAndSet(false, true)) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.CodelessEvents, new FeatureManager.Callback() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda3
                ...
                public final void onCompleted(boolean z) {
                    ActivityLifecycleTracker.m1025startTracking$lambda0(z);
                }
            });
            appId = appId2;
    ...
    public static final void m1025startTracking$lambda0(boolean z) {
        if (z) {
    ...
    public static final void onActivityCreated(Activity activity) {
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda4
            ...
            public final void run() {
                ActivityLifecycleTracker.m1021onActivityCreated$lambda1();
            }
        });
    }
    ...
    public static final void m1021onActivityCreated$lambda1() {
    ...
    public static final void onActivityResumed(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda2
            ...
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m1024onActivityResumed$lambda2(currentTimeMillis, activityName, applicationContext);
            }
        });
    }
    ...
    public static final void m1024onActivityResumed$lambda2(long j, String activityName, Context appContext) {
        SessionInfo sessionInfo;
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda1
            ...
            @Override // java.lang.Runnable
            public final void run() {
                ActivityLifecycleTracker.m1022onActivityPaused$lambda6(currentTimeMillis, activityName);
            }
        });
    }
    ...
    public static final void m1022onActivityPaused$lambda6(final long j, final String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
        ...
        if (foregroundActivityCount.get() <= 0) {
            Runnable runnable = new Runnable() { // from class: com.facebook.appevents.internal.ActivityLifecycleTracker$$ExternalSyntheticLambda0
                ...
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityLifecycleTracker.m1023onActivityPaused$lambda6$lambda4(j, activityName);
                }
            };
    ...
    public static final void m1023onActivityPaused$lambda6$lambda4(long j, String activityName) {
        Intrinsics.checkNotNullParameter(activityName, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), null, null, 4, null);
        }
