...
@Metadata(m838d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\n"}, m839d2 = {"<anonymous>", "", "<anonymous parameter 0>", "", "responseCode", ""}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
...
final class C0789xf719cce4 extends Lambda implements Function2<String, Integer, Unit> {
    final /* synthetic */ List<Map<String, Object>> $processedEvents;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    C0789xf719cce4(List<? extends Map<String, ? extends Object>> list) {
        super(2);
    ...
    public final void invoke2(String str, final Integer num) {
        ...
        Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.cloudbridge.AppEventsConversionsAPITransformerWebRequests$transformGraphRequestAndSendToCAPIGEndPoint$1$1$$ExternalSyntheticLambda0
            ...
            public final void run() {
                C0789xf719cce4.m998invoke$lambda0(num, list);
            }
        });
    }
    ...
    public static final void m998invoke$lambda0(Integer num, List processedEvents) {
        HashSet hashSet;
