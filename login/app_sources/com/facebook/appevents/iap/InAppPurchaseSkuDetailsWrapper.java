...
public final class InAppPurchaseSkuDetailsWrapper {
    ...
    public final Object getSkuDetailsParams(String skuType, List<String> skuIDs) {
        ...
        try {
            ...
            Object invokeMethod2 = InAppPurchaseUtils.invokeMethod(this.builderClazz, this.setTypeMethod, invokeMethod, skuType);
            if (invokeMethod2 == null) {
                return null;
            }
            InAppPurchaseUtils inAppPurchaseUtils3 = InAppPurchaseUtils.INSTANCE;
            Object invokeMethod3 = InAppPurchaseUtils.invokeMethod(this.builderClazz, this.setSkusListMethod, invokeMethod2, skuIDs);
