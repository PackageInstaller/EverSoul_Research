...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0799R.layout.com_facebook_activity_layout);
    ...
    protected Fragment getFragment() {
        ...
        supportFragmentManager.beginTransaction().add(C0799R.id.com_facebook_fragment_container, loginFragment, FRAGMENT_TAG).commit();
