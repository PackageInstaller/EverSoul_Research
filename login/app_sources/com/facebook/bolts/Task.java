...
public final class Task<TResult> {
    ...
    /* compiled from: Task.kt */
    @Metadata(m838d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u001c\u0010\u0002\u001a\u00020\u00032\n\u0010\u0004\u001a\u0006\u0012\u0002\b\u00030\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, m839d2 = {"Lcom/facebook/bolts/Task$UnobservedExceptionHandler;", "", "unobservedException", "", "t", "Lcom/facebook/bolts/Task;", Constants.RequestBody.EXTRA_ATTRIBUTES_KEY, "Lcom/facebook/bolts/UnobservedTaskException;", "facebook-bolts_release"}, m840k = 1, m841mv = {1, 5, 1}, m843xi = 48)
    ...
    public final Task<Void> makeVoid() {
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.Task$$ExternalSyntheticLambda3
            ...
            public final Object then(Task task) {
                Task m1042makeVoid$lambda8;
                m1042makeVoid$lambda8 = Task.m1042makeVoid$lambda8(task);
                return m1042makeVoid$lambda8;
            }
        });
    }
    ...
    public static final Task m1042makeVoid$lambda8(Task task) {
        ...
        try {
            ...
            if (!isCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.Task$$ExternalSyntheticLambda1
                    ...
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m1040continueWith$lambda10$lambda9;
                        m1040continueWith$lambda10$lambda9 = Task.m1040continueWith$lambda10$lambda9(TaskCompletionSource.this, continuation, executor, ct, task);
                        return m1040continueWith$lambda10$lambda9;
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final Void m1040continueWith$lambda10$lambda9(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        ...
        try {
            ...
            if (!isCompleted && (list = this.continuations) != null) {
                list.add(new Continuation() { // from class: com.facebook.bolts.Task$$ExternalSyntheticLambda2
                    ...
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m1041continueWithTask$lambda12$lambda11;
                        m1041continueWithTask$lambda12$lambda11 = Task.m1041continueWithTask$lambda12$lambda11(TaskCompletionSource.this, continuation, executor, ct, task);
                        return m1041continueWithTask$lambda12$lambda11;
                    }
                });
            }
            Unit unit = Unit.INSTANCE;
    ...
    public static final Void m1041continueWithTask$lambda12$lambda11(com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(tcs, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccess(final Continuation<TResult, TContinuationResult> continuation, Executor executor, final CancellationToken ct) {
        ...
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.Task$$ExternalSyntheticLambda0
            ...
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                Task m1043onSuccess$lambda13;
                m1043onSuccess$lambda13 = Task.m1043onSuccess$lambda13(CancellationToken.this, continuation, task);
                return m1043onSuccess$lambda13;
            }
        }, executor);
    }
    ...
    public static final Task m1043onSuccess$lambda13(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return INSTANCE.cancelled();
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccessTask(final Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, final CancellationToken ct) {
        ...
        return continueWithTask(new Continuation() { // from class: com.facebook.bolts.Task$$ExternalSyntheticLambda4
            ...
            @Override // com.facebook.bolts.Continuation
            public final Object then(Task task) {
                Task m1044onSuccessTask$lambda14;
                m1044onSuccessTask$lambda14 = Task.m1044onSuccessTask$lambda14(CancellationToken.this, continuation, task);
                return m1044onSuccessTask$lambda14;
            }
        }, executor);
    }
    ...
    public static final Task m1044onSuccessTask$lambda14(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return INSTANCE.cancelled();
    ...
    /* compiled from: Task.kt */
    @Metadata(m838d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0087\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0007\b\u0000¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, m839d2 = {"Lcom/facebook/bolts/Task$TaskCompletionSource;", "Lcom/facebook/bolts/TaskCompletionSource;", "(Lcom/facebook/bolts/Task;)V", "facebook-bolts_release"}, m840k = 1, m841mv = {1, 5, 1}, m843xi = 48)
    ...
    public static final class Companion {
        ...
        public final Task<Void> delay$facebook_bolts_release(long delay, ScheduledExecutorService executor, CancellationToken cancellationToken) {
            ...
            final ScheduledFuture<?> schedule = executor.schedule(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda4
                ...
                public final void run() {
                    Task.Companion.m1051delay$lambda0(TaskCompletionSource.this);
                }
            ...
            if (cancellationToken != null) {
                cancellationToken.register(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda5
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m1052delay$lambda1(schedule, taskCompletionSource);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final void m1051delay$lambda0(com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public static final void m1052delay$lambda1(ScheduledFuture scheduledFuture, com.facebook.bolts.TaskCompletionSource tcs) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
        ...
        public final <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor, final CancellationToken ct) {
            ...
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda1
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m1047call$lambda2(CancellationToken.this, taskCompletionSource, callable);
                    }
                });
            } catch (Exception e) {
        ...
        public static final void m1047call$lambda2(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Callable callable) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(callable, "$callable");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                tcs.setCancelled();
        ...
        public final <TResult> Task<Task<TResult>> whenAnyResult(Collection<Task<TResult>> tasks) {
            ...
            while (it.hasNext()) {
                it.next().continueWith(new Continuation() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda0
                    ...
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m1054whenAnyResult$lambda3;
                        m1054whenAnyResult$lambda3 = Task.Companion.m1054whenAnyResult$lambda3(atomicBoolean, taskCompletionSource, task);
                        return m1054whenAnyResult$lambda3;
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m1054whenAnyResult$lambda3(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
        ...
        public final Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
            ...
            while (it.hasNext()) {
                it.next().continueWith(new Continuation() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda6
                    ...
                    @Override // com.facebook.bolts.Continuation
                    public final Object then(Task task) {
                        Void m1053whenAny$lambda4;
                        m1053whenAny$lambda4 = Task.Companion.m1053whenAny$lambda4(atomicBoolean, taskCompletionSource, task);
                        return m1053whenAny$lambda4;
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m1053whenAny$lambda4(AtomicBoolean isAnyTaskComplete, com.facebook.bolts.TaskCompletionSource firstCompleted, Task it) {
            Intrinsics.checkNotNullParameter(isAnyTaskComplete, "$isAnyTaskComplete");
            Intrinsics.checkNotNullParameter(firstCompleted, "$firstCompleted");
            Intrinsics.checkNotNullParameter(it, "it");
            if (isAnyTaskComplete.compareAndSet(false, true)) {
        ...
        public final <TContinuationResult, TResult> void completeImmediately(final com.facebook.bolts.TaskCompletionSource<TContinuationResult> tcs, final Continuation<TResult, TContinuationResult> continuation, final Task<TResult> task, Executor executor, final CancellationToken ct) {
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda2
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m1050completeImmediately$lambda5(CancellationToken.this, tcs, continuation, task);
                    }
                });
            } catch (Exception e) {
        ...
        public static final void m1050completeImmediately$lambda5(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
        ...
        public final <TContinuationResult, TResult> void completeAfterTask(final com.facebook.bolts.TaskCompletionSource<TContinuationResult> tcs, final Continuation<TResult, Task<TContinuationResult>> continuation, final Task<TResult> task, Executor executor, final CancellationToken ct) {
            try {
                executor.execute(new Runnable() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda3
                    ...
                    @Override // java.lang.Runnable
                    public final void run() {
                        Task.Companion.m1048completeAfterTask$lambda7(CancellationToken.this, tcs, continuation, task);
                    }
                });
            } catch (Exception e) {
                tcs.setError(new ExecutorException(e));
        ...
        public static final void m1048completeAfterTask$lambda7(final CancellationToken cancellationToken, final com.facebook.bolts.TaskCompletionSource tcs, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                ...
                if (task2 != null) {
                    task2.continueWith(new Continuation() { // from class: com.facebook.bolts.Task$Companion$$ExternalSyntheticLambda7
                        ...
                        public final Object then(Task task3) {
                            Void m1049completeAfterTask$lambda7$lambda6;
                            m1049completeAfterTask$lambda7$lambda6 = Task.Companion.m1049completeAfterTask$lambda7$lambda6(CancellationToken.this, tcs, task3);
                            return m1049completeAfterTask$lambda7$lambda6;
                        }
                    });
                } else {
                    tcs.setResult(null);
        ...
        public static final Void m1049completeAfterTask$lambda7$lambda6(CancellationToken cancellationToken, com.facebook.bolts.TaskCompletionSource tcs, Task task) {
            Intrinsics.checkNotNullParameter(tcs, "$tcs");
            Intrinsics.checkNotNullParameter(task, "task");
            if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
                tcs.setCancelled();
