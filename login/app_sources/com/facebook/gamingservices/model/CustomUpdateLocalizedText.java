...
public final /* data */ class CustomUpdateLocalizedText {
    ...
    public final JSONObject toJSONObject() {
        ...
        jSONObject.put(Constants.VALIDATION_DEFAULT, this.default);
        HashMap<String, String> hashMap = this.localizations;
        if (hashMap != null) {
