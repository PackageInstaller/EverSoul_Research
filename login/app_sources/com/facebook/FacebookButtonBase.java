...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String analyticsButtonCreatedEventName, String analyticsButtonTappedEventName) {
        ...
        configureButton(context, attributeSet, i, i2 == 0 ? C0799R.style.com_facebook_button : i2);
        ...
        try {
            ...
            try {
                if (obtainStyledAttributes.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C0799R.color.com_facebook_blue));
                }
            } finally {
        ...
        try {
            super.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.FacebookButtonBase$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    FacebookButtonBase.m938setupOnClickListener$lambda0(FacebookButtonBase.this, view);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final void m938setupOnClickListener$lambda0(FacebookButtonBase this$0, View view) {
