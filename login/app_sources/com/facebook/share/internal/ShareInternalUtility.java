...
public final class ShareInternalUtility {
        ...
        return new ResultProcessor(callback) { // from class: com.facebook.share.internal.ShareInternalUtility$getShareResultProcessor$1
            ...
            public void onSuccess(AppCall appCall, Bundle results) {
                ...
                if (results != null) {
                    ...
                    if (StringsKt.equals(Base2ndPWViewData.KEY_CANCEL, nativeDialogCompletionGesture, true)) {
    ...
    public static final void registerStaticShareCallback(final int requestCode) {
        CallbackManagerImpl.INSTANCE.registerStaticCallback(requestCode, new CallbackManagerImpl.Callback() { // from class: com.facebook.share.internal.ShareInternalUtility$$ExternalSyntheticLambda0
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                boolean m1158registerStaticShareCallback$lambda0;
                m1158registerStaticShareCallback$lambda0 = ShareInternalUtility.m1158registerStaticShareCallback$lambda0(requestCode, i, intent);
                return m1158registerStaticShareCallback$lambda0;
            }
        });
    }
    ...
    public static final boolean m1158registerStaticShareCallback$lambda0(int i, int i2, Intent intent) {
    ...
    public static final void registerSharerCallback(final int requestCode, CallbackManager callbackManager, final FacebookCallback<Sharer.Result> callback) {
        ...
        ((CallbackManagerImpl) callbackManager).registerCallback(requestCode, new CallbackManagerImpl.Callback() { // from class: com.facebook.share.internal.ShareInternalUtility$$ExternalSyntheticLambda1
            ...
            @Override // com.facebook.internal.CallbackManagerImpl.Callback
            public final boolean onActivityResult(int i, Intent intent) {
                boolean m1157registerSharerCallback$lambda1;
                m1157registerSharerCallback$lambda1 = ShareInternalUtility.m1157registerSharerCallback$lambda1(requestCode, callback, i, intent);
                return m1157registerSharerCallback$lambda1;
            }
        });
    }
    ...
    public static final boolean m1157registerSharerCallback$lambda1(int i, FacebookCallback facebookCallback, int i2, Intent intent) {
    ...
    public static final String getUriExtension(Uri uri) {
        ...
        int lastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) uri2, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null);
