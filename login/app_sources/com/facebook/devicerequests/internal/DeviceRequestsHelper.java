...
public final class DeviceRequestsHelper {
    ...
    private final boolean startAdvertisementServiceImpl(final String userCode) {
        ...
        try {
            ...
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            final String str = "fbsdk_" + Intrinsics.stringPlus("android-", StringsKt.replace$default(FacebookSdk.getSdkVersion(), ClassUtils.PACKAGE_SEPARATOR_CHAR, '|', false, 4, (Object) null)) + '_' + ((Object) userCode);
