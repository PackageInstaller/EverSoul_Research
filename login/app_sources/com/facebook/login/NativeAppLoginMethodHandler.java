...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
            ...
            if (!Utility.isNullOrEmpty(extras.getString("code"))) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.NativeAppLoginMethodHandler$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        NativeAppLoginMethodHandler.m1146processSuccessResponse$lambda0(NativeAppLoginMethodHandler.this, request, extras);
                    }
                });
                return;
            }
    ...
    public static final void m1146processSuccessResponse$lambda0(NativeAppLoginMethodHandler this$0, LoginClient.Request request, Bundle extras) {
