...
public interface Constants {
    ...
    public static final String SDK_VERSION = String.format(Locale.US, "Singular/v%s", "12.5.5");
    public static final String HTTP_USER_AGENT = String.format(Locale.US, "Singular/SDK-v%s.%s", "12.5.5", "PROD");
