...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f529GS + format + f529GS + format2 + f529GS);
            } else {
                sb.insert(0, postCode3 + f529GS + format + f529GS + format2 + f529GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f348US, 32});
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f337EM, Ascii.SUB, Ascii.ESC, Ascii.f339FS, Ascii.f340GS, Ascii.f344RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f336CR, Ascii.f346SO, Ascii.f345SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f349VT, Ascii.f338FF, 1, 2});
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f348US, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f337EM, Ascii.SUB})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f339FS, Ascii.f340GS, Ascii.f344RS, 19, Ascii.DC4})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f336CR, Ascii.f346SO})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.f345SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f349VT, Ascii.f338FF, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (charAt) {
                ...
                case 65531:
                    ...
                    int i11 = i9 + 1;
                    int i12 = i10 + (bArr[i11] << Ascii.f338FF);
                    int i13 = i11 + 1;
