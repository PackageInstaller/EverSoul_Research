...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{476}, "AZ");
            add(new int[]{477}, "LT");
            add(new int[]{KGResult.KGResultCode.INVALID_PHONE_NUMBER}, "UZ");
            add(new int[]{479}, "LK");
            add(new int[]{AddOnManager.StoreResultCode.INVALID_TRANSACTION_ID}, "PH");
            add(new int[]{AddOnManager.StoreResultCode.INVALID_PURCHASE_TOKEN}, "BY");
            add(new int[]{AddOnManager.StoreResultCode.INCOMPLETE_PAYMENT}, "UA");
            add(new int[]{484}, "MD");
            add(new int[]{485}, "AM");
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
