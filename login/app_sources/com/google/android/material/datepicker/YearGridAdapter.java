...
class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C0903R.layout.mtrl_calendar_year, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        String string = viewHolder.textView.getContext().getString(C0903R.string.mtrl_picker_navigate_to_year_description);
