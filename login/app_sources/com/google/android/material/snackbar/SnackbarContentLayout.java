...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0903R.id.snackbar_text);
        this.actionView = (Button) findViewById(C0903R.id.snackbar_action);
    }
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0903R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    */
    protected void onMeasure(int r8, int r9) {
        /*
            ...
            int r1 = com.google.android.material.C0903R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C0903R.dimen.design_snackbar_padding_vertical
