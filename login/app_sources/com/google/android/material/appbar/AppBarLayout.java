...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0903R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0903R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        ...
        L2d:
            ...
            int[] r2 = com.google.android.material.C0903R.styleable.AppBarLayout
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r10
            r3 = r11
            ...
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_android_background
        ...
        L68:
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_expanded
        ...
        L79:
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_elevation
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto L8b
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_elevation
        ...
        L8b:
            ...
            r0 = 26
            if (r11 < r0) goto Lb3
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto La2
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r11 = r10.getBoolean(r11, r6)
        ...
        La2:
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r11 = r10.hasValue(r11)
            if (r11 == 0) goto Lb3
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r11 = r10.getBoolean(r11, r6)
        ...
        Lb3:
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_liftOnScroll
            boolean r11 = r10.getBoolean(r11, r6)
            r8.liftOnScroll = r11
            int r11 = com.google.android.material.C0903R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r9 = r10.getResourceId(r11, r9)
            r8.liftOnScrollTargetViewId = r9
            int r9 = com.google.android.material.C0903R.styleable.AppBarLayout_statusBarForeground
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? C0903R.attr.state_liftable : -C0903R.attr.state_liftable;
        iArr[1] = (this.liftable && this.lifted) ? C0903R.attr.state_lifted : -C0903R.attr.state_lifted;
        iArr[2] = this.liftable ? C0903R.attr.state_collapsible : -C0903R.attr.state_collapsible;
        iArr[3] = (this.liftable && this.lifted) ? C0903R.attr.state_collapsed : -C0903R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C0903R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration(getResources().getInteger(C0903R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0903R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C0903R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            setScrollEffect(createScrollEffectFromInt(obtainStyledAttributes.getInt(C0903R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0)));
            if (obtainStyledAttributes.hasValue(C0903R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(C0903R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0903R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C0903R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            obtainStyledAttributes.recycle();
        }
