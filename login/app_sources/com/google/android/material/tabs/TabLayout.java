...
public class TabLayout extends HorizontalScrollView {
    ...
    ViewPager viewPager;
    private static final int DEF_STYLE_RES = C0903R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0903R.attr.tabStyle);
    }
    ...
    */
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f268id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f268id);
        }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0903R.layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0903R.layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
