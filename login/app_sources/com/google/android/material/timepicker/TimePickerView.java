...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C0903R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0903R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0903R.id.material_clock_face);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView.2
            ...
            public void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                int i3 = i2 == C0903R.id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.hourView = chip2;
        this.clockHandView = (ClockHandView) findViewById(C0903R.id.material_clock_hand);
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0903R.id.selection_type, 12);
        this.hourView.setTag(C0903R.id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C0903R.id.material_clock_period_pm_button : C0903R.id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0903R.id.material_clock_display, ViewCompat.getLayoutDirection(this) == 0 ? 2 : 1);
