...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3) {
        ...
        arrayList.add(ofFloat);
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), C0903R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C0903R.integer.material_motion_duration_long_1)));
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C0903R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
