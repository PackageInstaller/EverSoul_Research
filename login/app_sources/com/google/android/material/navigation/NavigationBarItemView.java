...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C0903R.id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C0903R.id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C0903R.id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C0903R.id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C0903R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0903R.id.navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C0903R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C0903R.attr.motionDurationLong1, getResources().getInteger(C0903R.integer.material_motion_duration_long_1)));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        wrap.setRoleDescription(getResources().getString(C0903R.string.item_view_role_description));
    }
    ...
    protected int getItemBackgroundResId() {
        return C0903R.drawable.mtrl_navigation_bar_item_background;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    protected int getItemDefaultMarginResId() {
        return C0903R.dimen.mtrl_navigation_bar_item_default_margin;
    }
