...
public final class zzng extends zzia {
    ...
    */
    private final int zza(java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.Object r19, android.os.Bundle r20, java.util.List<java.lang.String> r21, boolean r22, boolean r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzng.zza(java.lang.String, java.lang.String, java.lang.String, java.lang.Object, android.os.Bundle, java.util.List, boolean, boolean):int");
    }
    ...
    final int zza(String str) {
        ...
        if (zza(NotificationCompat.CATEGORY_EVENT, zzig.zza, zzig.zzb, str)) {
    ...
    final int zzb(String str) {
        ...
        if (zza("user property", zzih.zza, str)) {
    ...
    final long zzh() {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            ...
            j = zzc() < zzbg.zzav.zza(null).intValue() ? 16L : 0L;
        }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static long zza(zzaz zzazVar) {
        long j = 0;
        if (zzazVar == null) {
            return 0L;
        }
        ...
        while (it.hasNext()) {
            if (zzazVar.zzc(it.next()) instanceof Parcelable[]) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static Bundle zza(List<zznb> list) {
        ...
        for (zznb zznbVar : list) {
            if (zznbVar.zzd != null) {
                bundle.putString(zznbVar.zza, zznbVar.zzd);
            } else if (zznbVar.zzc != null) {
                bundle.putLong(zznbVar.zza, zznbVar.zzc.longValue());
            } else if (zznbVar.zzf != null) {
                bundle.putDouble(zznbVar.zza, zznbVar.zzf.doubleValue());
            }
        }
        return bundle;
    }
    ...
    final Bundle zza(String str, String str2, Bundle bundle, List<String> list, boolean z) {
        ...
        int i;
        zzng zzngVar = this;
        boolean zza2 = zza(str2, zzig.zzd);
        if (bundle == null) {
            return null;
        }
        Bundle bundle2 = new Bundle(bundle);
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            if (list == null || !list.contains(str3)) {
                zzl = !z ? zzngVar.zzl(str3) : 0;
                if (zzl == 0) {
                    zzl = zzngVar.zzk(str3);
                }
            } else {
                zzl = 0;
            }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    final zzbe zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
        if (zza(str2) != 0) {
        ...
        return new zzbe(str2, new zzaz(zza2), str3, j);
    }
    ...
    public static ArrayList<Bundle> zzb(List<zzae> list) {
        ...
        for (zzae zzaeVar : list) {
            ...
            zzic.zza(bundle, Preconditions.checkNotNull(zzaeVar.zzc.zza()));
            ...
            if (zzaeVar.zzg != null) {
                zzbe zzbeVar = zzaeVar.zzg;
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, zzbeVar.zza);
                if (zzbeVar.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, zzbeVar.zzb.zzb());
                }
            }
            bundle.putLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, zzaeVar.zzh);
            if (zzaeVar.zzi != null) {
                zzbe zzbeVar2 = zzaeVar.zzi;
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, zzbeVar2.zza);
                if (zzbeVar2.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, zzbeVar2.zzb.zzb());
                }
            }
            ...
            if (zzaeVar.zzk != null) {
                ...
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, zzbeVar3.zza);
                if (zzbeVar3.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, zzbeVar3.zzb.zzb());
                }
            }
    ...
    final void zza(Parcelable[] parcelableArr, int i, boolean z) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            for (String str : new TreeSet(bundle.keySet())) {
                if (zzh(str) && !zza(str, zzii.zzd) && (i2 = i2 + 1) > i) {
                    if (z) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    final void zza(zzft zzftVar, int i) {
        int i2 = 0;
        for (String str : new TreeSet(zzftVar.zzb.keySet())) {
            if (zzh(str) && (i2 = i2 + 1) > i) {
                zzj().zzh().zza("Event can't contain more than " + i + " params", zzi().zza(zzftVar.zza), zzi().zza(zzftVar.zzb));
                zzb(zzftVar.zzb, 5);
                zzftVar.zzb.remove(str);
            }
        }
    }
        ...
        for (String str5 : new TreeSet(bundle.keySet())) {
            ...
            if (zzl != 0) {
                ...
                if (zza2 != 0 && !"_ev".equals(str4)) {
                    ...
                    bundle.remove(str4);
                } else if (zzh(str4) && !zza(str4, zzii.zzd)) {
                    int i2 = i + 1;
    ...
    static boolean zzd(String str) {
        String zza2 = zzbg.zzaz.zza(null);
    ...
    final boolean zza(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (this.zzu.zzae()) {
                zzj().zzh().zza("Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id", zzfp.zza(str));
            }
            return false;
        }
        if (!TextUtils.isEmpty(str2)) {
            ...
            zzj().zzh().zza("Invalid admob_app_id. Analytics disabled.", zzfp.zza(str2));
            return false;
        }
        if (this.zzu.zzae()) {
