...
abstract class zzz {
    ...
    */
    private static java.lang.Boolean zza(java.math.BigDecimal r8, com.google.android.gms.internal.measurement.zzew.zzd r9, double r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzz.zza(java.math.BigDecimal, com.google.android.gms.internal.measurement.zzew$zzd, double):java.lang.Boolean");
    }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    static Boolean zza(String str, zzew.zzf zzfVar, zzfp zzfpVar) {
        String zze;
        List<String> list;
        ...
        return zza(str, zzb, zzg, str2, list, zzb == zzew.zzf.zza.REGEXP ? str2 : null, zzfpVar);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static Boolean zza(String str, zzew.zzf.zza zzaVar, boolean z, String str2, List<String> list, String str3, zzfp zzfpVar) {
        if (str == null) {
            return null;
        }
            ...
            case 1:
                if (str3 != null) {
                    try {
                        ...
                        if (zzfpVar != null) {
                            zzfpVar.zzu().zza("Invalid regular expression in REGEXP audience filter. expression", str3);
                        }
                        return null;
                    }
                }
