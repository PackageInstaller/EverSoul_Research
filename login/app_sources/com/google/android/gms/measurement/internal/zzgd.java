...
public final class zzgd {
    ...
    */
    public final android.os.Bundle zza() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzgd.zza():android.os.Bundle");
    }
        ...
        for (String str : bundle.keySet()) {
            ...
            if (obj != null) {
                try {
                    ...
                    jSONObject.put(AgreementService.VALUE_NO, str);
                    if (zzph.zza() && this.zzd.zze().zza(zzbg.zzcf)) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public zzgd(zzgb zzgbVar, String str, Bundle bundle) {
        this.zzd = zzgbVar;
