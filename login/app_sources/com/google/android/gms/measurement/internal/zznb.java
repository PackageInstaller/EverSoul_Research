...
public final class zznb extends AbstractSafeParcelable {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    zznb(zznd zzndVar) {
        this(zzndVar.zzc, zzndVar.zzd, zzndVar.zze, zzndVar.zzb);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    zznb(String str, long j, Object obj, String str2) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    zznb(int i, String str, long j, Long l, Float f, String str2, String str3, Double d) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
