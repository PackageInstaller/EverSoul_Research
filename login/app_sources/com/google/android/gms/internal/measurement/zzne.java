...
interface zzne {
    ...
    void zza(int i, zzhu zzhuVar) throws IOException;

    <K, V> void zza(int i, zzkm<K, V> zzkmVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzlj zzljVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzhu> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzlj zzljVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzlj zzljVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzlj zzljVar) throws IOException;
