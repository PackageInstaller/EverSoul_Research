...
final class zziq extends zzho<Double> implements zzjn<Double>, zzld, RandomAccess {
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzjh.zza(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* synthetic */ zzjn<Double> zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zziq(Arrays.copyOf(this.zzb, i), this.zzc, true);
    }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private zziq(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
