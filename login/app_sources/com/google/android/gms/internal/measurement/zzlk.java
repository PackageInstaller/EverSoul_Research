...
interface zzlk {
    ...
    <T> void zza(T t, zzlj<T> zzljVar, zzis zzisVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzlj<T> zzljVar, zzis zzisVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzkm<K, V> zzkmVar, zzis zzisVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzlj<T> zzljVar, zzis zzisVar) throws IOException;

    void zzb(List<zzhu> list) throws IOException;

    <T> void zzb(List<T> list, zzlj<T> zzljVar, zzis zzisVar) throws IOException;
