...
final class zzdi extends zzdf.zza {
    ...
    public final void zza() {
        ...
        try {
            ...
            zzdd zzddVar = new zzdd(84002L, Math.max(localVersion, r0), DynamiteModule.getRemoteVersion(this.zze, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzf, com.google.android.gms.measurement.internal.zzgx.zza(this.zze));
