...
final class zzmt extends zzmq {
    ...
    */
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    @Override // com.google.android.gms.internal.measurement.zzmq
    final String zza(byte[] bArr, int i, int i2) throws zzjq {
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                int i8 = i6 + 1;
                zzmr.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                i = i8 + 1;
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                ...
                byte b4 = bArr[i6];
                int i10 = i9 + 1;
                zzmr.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                i = i10 + 1;
                i5 = i5 + 1 + 1;
            }
        }
