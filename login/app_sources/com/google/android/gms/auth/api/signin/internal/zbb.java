    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m159e("Unable to revoke access!", new Object[0]);
            }
            zba.m157d("Response Code: " + responseCode, new Object[0]);
        } catch (IOException e) {
            zba.m159e("IOException when revoking access: ".concat(String.valueOf(e.toString())), new Object[0]);
        } catch (Exception e2) {
            zba.m159e("Exception when revoking access: ".concat(String.valueOf(e2.toString())), new Object[0]);
        }
