...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount zab(String str) throws JSONException {
        ...
        GoogleSignInAccount zaa2 = zaa(jSONObject.optString("id"), jSONObject.has("tokenId") ? jSONObject.optString("tokenId") : null, jSONObject.has("email") ? jSONObject.optString("email") : null, jSONObject.has(KGSession.KGAppInfo.KEY_DISPLAY_NAME) ? jSONObject.optString(KGSession.KGAppInfo.KEY_DISPLAY_NAME) : null, jSONObject.has("givenName") ? jSONObject.optString("givenName") : null, jSONObject.has("familyName") ? jSONObject.optString("familyName") : null, parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet);
    ...
    public final String zad() {
        ...
        try {
            ...
            if (getDisplayName() != null) {
                jSONObject.put(KGSession.KGAppInfo.KEY_DISPLAY_NAME, getDisplayName());
            }
