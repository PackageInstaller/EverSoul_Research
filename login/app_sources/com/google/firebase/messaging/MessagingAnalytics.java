...
public class MessagingAnalytics {
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, TransportFactory transportFactory) {
        ...
        try {
            transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, Encoding.m106of("proto"), new Transformer() { // from class: com.google.firebase.messaging.MessagingAnalytics$$ExternalSyntheticLambda0
                /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    ...
    static String getInstanceId(Bundle bundle) {
        String string = bundle.getString(Constants.MessagePayloadKeys.f438TO);
    ...
    private static int getMessagePriority(String str) {
        if (com.singular.sdk.internal.Constants.HIGH.equals(str)) {
            return 1;
        }
        return com.singular.sdk.internal.Constants.NORMAL.equals(str) ? 2 : 0;
    }
