...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f438TO);
    }
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            bundle.putString(Constants.MessagePayloadKeys.f438TO, str);
        }
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        public int getTtl() {
            return Integer.parseInt(this.bundle.getString(Constants.MessagePayloadKeys.MESSAGE_TYPE, AppEventsConstants.EVENT_PARAM_VALUE_NO));
        }
