...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(discoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m373of(context, (Class<Context>) Context.class, (Class<? super Context>[]) new Class[0])).addComponent(Component.m373of(this, (Class<FirebaseApp>) FirebaseApp.class, (Class<? super FirebaseApp>[]) new Class[0])).addComponent(Component.m373of(firebaseOptions, (Class<FirebaseOptions>) FirebaseOptions.class, (Class<? super FirebaseOptions>[]) new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m373of(startupTime, (Class<StartupTime>) StartupTime.class, (Class<? super StartupTime>[]) new Class[0]));
        }
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return FirebaseApp.this.m1167lambda$new$0$comgooglefirebaseFirebaseApp(context);
            }
        });
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.this.m1168lambda$new$1$comgooglefirebaseFirebaseApp(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    /* synthetic */ DataCollectionConfigStorage m1167lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    /* synthetic */ void m1168lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (z) {
            return;
        }
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m850m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m850m(INSTANCE, null, globalBackgroundStateListener)) {
