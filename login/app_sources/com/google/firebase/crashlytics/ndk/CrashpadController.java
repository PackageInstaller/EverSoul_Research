...
public class CrashpadController {
    ...
    public boolean initialize(String str, String str2, long j, StaticSessionData staticSessionData) {
        ...
        try {
            ...
            Logger.getLogger().m393e("Error initializing Crashlytics NDK", e);
            return false;
        }
    }
    ...
    public SessionFiles getFilesForSession(String str) {
        ...
        Logger.getLogger().m396v("Minidump directory: " + file.getAbsolutePath());
        File singleFileWithExtension = getSingleFileWithExtension(file, ".dmp");
        Logger.getLogger().m396v("Minidump file ".concat((singleFileWithExtension == null || !singleFileWithExtension.exists()) ? "does not exist" : "exists"));
    ...
    private static String getTraceFileFromApplicationExitInfo(ApplicationExitInfo applicationExitInfo) {
        try {
            ...
            Logger.getLogger().m398w("Failed to get input stream from ApplicationExitInfo");
            return null;
        }
    }
