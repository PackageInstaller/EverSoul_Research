...
public class FirebaseCrashlytics {
    ...
    static FirebaseCrashlytics init(FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Deferred<CrashlyticsNativeComponent> deferred, Deferred<AnalyticsConnector> deferred2, Deferred<FirebaseRemoteConfigInterop> deferred3) {
        ...
        Logger.getLogger().m394i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        Logger.getLogger().m390d("Mapping file ID is: " + mappingFileId);
        for (BuildIdInfo buildIdInfo2 : buildIdInfo) {
            Logger.getLogger().m390d(String.format("Build id for %s on %s: %s", buildIdInfo2.getLibraryName(), buildIdInfo2.getArch(), buildIdInfo2.getBuildId()));
        }
        try {
            ...
            Logger.getLogger().m396v("Installer package name is: " + create.installerPackageName);
            ...
            create2.loadSettingsData(buildSingleThreadExecutorService2).continueWith(buildSingleThreadExecutorService2, new Continuation<Void, Object>() { // from class: com.google.firebase.crashlytics.FirebaseCrashlytics.1
                ...
                public Object then(Task<Void> task) throws Exception {
                    ...
                    Logger.getLogger().m393e("Error fetching settings.", task.getException());
                    return null;
                }
            });
            ...
            Logger.getLogger().m393e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().m398w("A null value was passed to recordException. Ignoring.");
        } else {
