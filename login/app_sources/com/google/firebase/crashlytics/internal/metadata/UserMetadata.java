...
public class UserMetadata {
        ...
        synchronized (this.userId) {
            ...
            this.backgroundWorker.submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return UserMetadata.this.m400x76e191c7();
                }
            });
        }
    }
    ...
    /* synthetic */ Object m400x76e191c7() throws Exception {
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            ...
            this.backgroundWorker.submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$$ExternalSyntheticLambda1
                ...
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return UserMetadata.this.m401x8982b7e8(rolloutAssignmentList);
                }
            });
            return true;
        }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: lambda$updateRolloutsState$1$com-google-firebase-crashlytics-internal-metadata-UserMetadata */
    /* synthetic */ Object m401x8982b7e8(List list) throws Exception {
    ...
    class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            Callable callable = new Callable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$SerializeableKeysMap$$ExternalSyntheticLambda0
                ...
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return UserMetadata.SerializeableKeysMap.this.m402xb9b680d3();
                }
            };
            if (UByte$$ExternalSyntheticBackport0.m850m(this.queuedSerializer, null, callable)) {
        ...
        /* synthetic */ Void m402xb9b680d3() throws Exception {
