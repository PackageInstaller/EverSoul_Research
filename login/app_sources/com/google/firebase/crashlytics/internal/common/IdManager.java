...
public class IdManager implements InstallIdProvider {
    ...
    public synchronized InstallIdProvider.InstallIds getInstallIds() {
        ...
        Logger.getLogger().m396v("Determining Crashlytics installation ID...");
        SharedPreferences sharedPrefs = CommonUtils.getSharedPrefs(this.appContext);
        String string = sharedPrefs.getString(PREFKEY_FIREBASE_IID, null);
        Logger.getLogger().m396v("Cached Firebase Installation ID: " + string);
        if (this.dataCollectionArbiter.isAutomaticDataCollectionEnabled()) {
            String fetchTrueFid = fetchTrueFid();
            Logger.getLogger().m396v("Fetched Firebase Installation ID: " + fetchTrueFid);
        ...
        Logger.getLogger().m396v("Install IDs: " + this.installIds);
        return this.installIds;
    }
    ...
    public String fetchTrueFid() {
        try {
            ...
            Logger.getLogger().m399w("Failed to retrieve Firebase Installation ID.", e);
            return null;
        }
    }
    ...
    private synchronized String createAndCacheCrashlyticsInstallId(String str, SharedPreferences sharedPreferences) {
        ...
        Logger.getLogger().m396v("Created new Crashlytics installation ID: " + formatId + " for FID: " + str);
