...
public class SettingsController implements SettingsProvider {
                ...
                if (readCachedSettings != null) {
                    ...
                    if (parseSettingsJson != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && parseSettingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m396v("Cached settings have expired.");
                        }
                        try {
                            Logger.getLogger().m396v("Returning cached settings.");
                            settings = parseSettingsJson;
                        } catch (Exception e) {
                            e = e;
                            settings = parseSettingsJson;
                            Logger.getLogger().m393e("Failed to get cached settings", e);
                            return settings;
                        }
                    } else {
                        Logger.getLogger().m393e("Failed to parse cached settings data.", null);
                    }
                } else {
                    Logger.getLogger().m390d("No cached settings data found.");
                }
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        Logger.getLogger().m390d(str + jSONObject.toString());
    }
