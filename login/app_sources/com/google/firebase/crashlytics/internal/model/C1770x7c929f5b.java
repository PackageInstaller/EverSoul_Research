...
final class C1770x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    private final long address;
    private final String code;
    private final String name;

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private C1770x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            return new C1770x7c929f5b(this.name, this.code, this.address.longValue());
        }
    }
}
