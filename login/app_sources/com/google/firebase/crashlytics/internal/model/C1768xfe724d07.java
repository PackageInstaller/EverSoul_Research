...
final class C1768xfe724d07 extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    ...
    private C1768xfe724d07(long j, long j2, String str, String str2) {
        this.baseAddress = j;
        this.size = j2;
        this.name = str;
        this.uuid = str2;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.BinaryImage build() {
            ...
            return new C1768xfe724d07(this.baseAddress.longValue(), this.size.longValue(), this.name, this.uuid);
        }
    }
}
