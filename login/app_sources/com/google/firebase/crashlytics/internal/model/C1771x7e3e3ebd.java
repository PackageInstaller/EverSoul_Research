...
final class C1771x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    private final List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> frames;
    private final int importance;
    private final String name;

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private C1771x7e3e3ebd(String str, int i, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list) {
        this.name = str;
        this.importance = i;
        this.frames = list;
    }
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            return new C1771x7e3e3ebd(this.name, this.importance.intValue(), this.frames);
        }
    }
}
