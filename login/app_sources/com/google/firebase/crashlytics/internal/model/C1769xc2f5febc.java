...
final class C1769xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private C1769xc2f5febc(String str, String str2, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
        this.frames = list;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            return new C1769xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
        }
    }
}
