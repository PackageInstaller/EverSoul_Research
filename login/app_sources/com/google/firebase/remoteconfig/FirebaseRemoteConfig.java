...
public class FirebaseRemoteConfig {
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda7
            ...
            public final Task then(Object obj) {
                return FirebaseRemoteConfig.this.m445xebd5994c((Void) obj);
            }
        });
    }
    ...
    /* synthetic */ Task m445xebd5994c(Void r1) throws Exception {
        return activate();
    }
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda9
            ...
            public final Object then(Task task3) {
                return FirebaseRemoteConfig.this.m444x98ca96b0(task, task2, task3);
            }
        });
    }
    ...
    /* synthetic */ Task m444x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda6
            ...
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return FirebaseRemoteConfig.this.m447xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }
    ...
    /* synthetic */ Void m447xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public Task<Void> reset() {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda2
            ...
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return FirebaseRemoteConfig.this.m446xf98246b6();
            }
        });
    }
    ...
    /* synthetic */ Void m446xf98246b6() throws Exception {
