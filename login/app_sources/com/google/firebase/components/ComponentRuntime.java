...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m373of(eventBus, (Class<EventBus>) EventBus.class, (Class<? super EventBus>[]) new Class[]{Subscriber.class, Publisher.class}));
        arrayList.add(Component.m373of(this, (Class<ComponentRuntime>) ComponentLoader.class, (Class<? super ComponentRuntime>[]) new Class[0]));
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda1
                    ...
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return ComponentRuntime.this.m374xc080f8d8(component);
                    }
                }));
            }
    ...
    /* synthetic */ Object m374xc080f8d8(Component component) {
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return OptionalProvider.m375of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap hashMap;
        if (UByte$$ExternalSyntheticBackport0.m850m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
