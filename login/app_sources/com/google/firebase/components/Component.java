...
public final class Component<T> {
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m371of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m373of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m372of(final T t, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
