...
public final class SessionsSettings {
    ...
    private static final ReadOnlyProperty<Context, DataStore<Preferences>> dataStore$delegate = PreferenceDataStoreDelegateKt.preferencesDataStore$default(SessionDataStoreConfigs.INSTANCE.getSETTINGS_CONFIG_NAME(), new ReplaceFileCorruptionHandler(new Function1<CorruptionException, Preferences>() { // from class: com.google.firebase.sessions.settings.SessionsSettings$Companion$dataStore$2
        ...
        public final Preferences invoke(CorruptionException ex) {
            ...
            Log.w("SessionsSettings", "CorruptionException in settings DataStore in " + ProcessDetailsProvider.INSTANCE.getProcessName$com_google_firebase_firebase_sessions() + ClassUtils.PACKAGE_SEPARATOR_CHAR, ex);
    ...
    */
    ...
    public final long m1204getSessionRestartTimeoutUwyO8pc() {
        Duration mo1202getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo1202getSessionRestartTimeoutFghU774();
        if (mo1202getSessionRestartTimeoutFghU774 != null) {
            long m2820unboximpl = mo1202getSessionRestartTimeoutFghU774.m2820unboximpl();
            if (m1203isValidSessionRestartTimeoutLRDsOJo(m2820unboximpl)) {
                return m2820unboximpl;
            }
        }
        Duration mo1202getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo1202getSessionRestartTimeoutFghU774();
        if (mo1202getSessionRestartTimeoutFghU7742 != null) {
            long m2820unboximpl2 = mo1202getSessionRestartTimeoutFghU7742.m2820unboximpl();
            if (m1203isValidSessionRestartTimeoutLRDsOJo(m2820unboximpl2)) {
                return m2820unboximpl2;
            }
        }
    ...
    private final boolean m1203isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2800isPositiveimpl(sessionRestartTimeout) && Duration.m2795isFiniteimpl(sessionRestartTimeout);
    }
