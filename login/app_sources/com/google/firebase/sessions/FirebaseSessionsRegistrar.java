...
@Metadata(m838d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0001\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u0005¢\u0006\u0002\u0010\u0002J6\u0010\u0003\u001a0\u0012,\u0012*\u0012\u000e\b\u0001\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006 \u0007*\u0014\u0012\u000e\b\u0001\u0012\n \u0007*\u0004\u0018\u00010\u00060\u0006\u0018\u00010\u00050\u00050\u0004H\u0016¨\u0006\t"}, m839d2 = {"Lcom/google/firebase/sessions/FirebaseSessionsRegistrar;", "Lcom/google/firebase/components/ComponentRegistrar;", "()V", "getComponents", "", "Lcom/google/firebase/components/Component;", "", "kotlin.jvm.PlatformType", "Companion", "com.google.firebase-firebase-sessions"}, m840k = 1, m841mv = {1, 7, 1}, m843xi = 48)
...
public final class FirebaseSessionsRegistrar implements ComponentRegistrar {
    ...
    public List<Component<? extends Object>> getComponents() {
        ...
        return CollectionsKt.listOf((Object[]) new Component[]{add2.add(Dependency.required(qualified3)).factory(new ComponentFactory() { // from class: com.google.firebase.sessions.FirebaseSessionsRegistrar$$ExternalSyntheticLambda0
            ...
            public final Object create(ComponentContainer componentContainer) {
                FirebaseSessions m1195getComponents$lambda0;
                m1195getComponents$lambda0 = FirebaseSessionsRegistrar.m1195getComponents$lambda0(componentContainer);
                return m1195getComponents$lambda0;
            }
            ...
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                SessionGenerator m1196getComponents$lambda1;
                m1196getComponents$lambda1 = FirebaseSessionsRegistrar.m1196getComponents$lambda1(componentContainer);
                return m1196getComponents$lambda1;
            }
            ...
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                SessionFirelogPublisher m1197getComponents$lambda2;
                m1197getComponents$lambda2 = FirebaseSessionsRegistrar.m1197getComponents$lambda2(componentContainer);
                return m1197getComponents$lambda2;
            }
            ...
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                SessionsSettings m1198getComponents$lambda3;
                m1198getComponents$lambda3 = FirebaseSessionsRegistrar.m1198getComponents$lambda3(componentContainer);
                return m1198getComponents$lambda3;
            }
            ...
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                SessionDatastore m1199getComponents$lambda4;
                m1199getComponents$lambda4 = FirebaseSessionsRegistrar.m1199getComponents$lambda4(componentContainer);
                return m1199getComponents$lambda4;
            }
            ...
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                SessionLifecycleServiceBinder m1200getComponents$lambda5;
                m1200getComponents$lambda5 = FirebaseSessionsRegistrar.m1200getComponents$lambda5(componentContainer);
                return m1200getComponents$lambda5;
            }
    ...
    public static final FirebaseSessions m1195getComponents$lambda0(ComponentContainer componentContainer) {
    ...
    public static final SessionGenerator m1196getComponents$lambda1(ComponentContainer componentContainer) {
    ...
    public static final SessionFirelogPublisher m1197getComponents$lambda2(ComponentContainer componentContainer) {
        Object obj = componentContainer.get(firebaseApp);
        Intrinsics.checkNotNullExpressionValue(obj, "container[firebaseApp]");
    ...
    public static final SessionsSettings m1198getComponents$lambda3(ComponentContainer componentContainer) {
        Object obj = componentContainer.get(firebaseApp);
        Intrinsics.checkNotNullExpressionValue(obj, "container[firebaseApp]");
    ...
    public static final SessionDatastore m1199getComponents$lambda4(ComponentContainer componentContainer) {
    ...
    public static final SessionLifecycleServiceBinder m1200getComponents$lambda5(ComponentContainer componentContainer) {
        Object obj = componentContainer.get(firebaseApp);
        Intrinsics.checkNotNullExpressionValue(obj, "container[firebaseApp]");
