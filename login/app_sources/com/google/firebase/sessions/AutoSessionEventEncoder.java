...
public final class AutoSessionEventEncoder implements Configurator {
    ...
    private static final class SessionEventEncoder implements ObjectEncoder<SessionEvent> {
        ...
        private static final FieldDescriptor EVENTTYPE_DESCRIPTOR = FieldDescriptor.m406of("eventType");
        private static final FieldDescriptor SESSIONDATA_DESCRIPTOR = FieldDescriptor.m406of("sessionData");
        private static final FieldDescriptor APPLICATIONINFO_DESCRIPTOR = FieldDescriptor.m406of("applicationInfo");
    ...
    private static final class SessionInfoEncoder implements ObjectEncoder<SessionInfo> {
        ...
        private static final FieldDescriptor SESSIONID_DESCRIPTOR = FieldDescriptor.m406of("sessionId");
        private static final FieldDescriptor FIRSTSESSIONID_DESCRIPTOR = FieldDescriptor.m406of("firstSessionId");
        private static final FieldDescriptor SESSIONINDEX_DESCRIPTOR = FieldDescriptor.m406of("sessionIndex");
        private static final FieldDescriptor EVENTTIMESTAMPUS_DESCRIPTOR = FieldDescriptor.m406of("eventTimestampUs");
        private static final FieldDescriptor DATACOLLECTIONSTATUS_DESCRIPTOR = FieldDescriptor.m406of("dataCollectionStatus");
    ...
    private static final class DataCollectionStatusEncoder implements ObjectEncoder<DataCollectionStatus> {
        ...
        private static final FieldDescriptor PERFORMANCE_DESCRIPTOR = FieldDescriptor.m406of("performance");
        private static final FieldDescriptor CRASHLYTICS_DESCRIPTOR = FieldDescriptor.m406of("crashlytics");
        private static final FieldDescriptor SESSIONSAMPLINGRATE_DESCRIPTOR = FieldDescriptor.m406of("sessionSamplingRate");
    ...
    private static final class ApplicationInfoEncoder implements ObjectEncoder<ApplicationInfo> {
        ...
        private static final FieldDescriptor APPID_DESCRIPTOR = FieldDescriptor.m406of("appId");
        private static final FieldDescriptor DEVICEMODEL_DESCRIPTOR = FieldDescriptor.m406of(ServerConstants.DEVICE_MODEL);
        private static final FieldDescriptor SESSIONSDKVERSION_DESCRIPTOR = FieldDescriptor.m406of("sessionSdkVersion");
        private static final FieldDescriptor OSVERSION_DESCRIPTOR = FieldDescriptor.m406of("osVersion");
        private static final FieldDescriptor LOGENVIRONMENT_DESCRIPTOR = FieldDescriptor.m406of("logEnvironment");
        private static final FieldDescriptor ANDROIDAPPINFO_DESCRIPTOR = FieldDescriptor.m406of("androidAppInfo");
    ...
    private static final class AndroidApplicationInfoEncoder implements ObjectEncoder<AndroidApplicationInfo> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.m406of(RemoteConfigConstants.RequestFieldKey.PACKAGE_NAME);
        private static final FieldDescriptor VERSIONNAME_DESCRIPTOR = FieldDescriptor.m406of("versionName");
        private static final FieldDescriptor APPBUILDVERSION_DESCRIPTOR = FieldDescriptor.m406of("appBuildVersion");
        private static final FieldDescriptor DEVICEMANUFACTURER_DESCRIPTOR = FieldDescriptor.m406of("deviceManufacturer");
