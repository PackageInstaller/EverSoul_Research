...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public void log(SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.m106of("json"), new Transformer() { // from class: com.google.firebase.sessions.EventGDTLogger$$ExternalSyntheticLambda0
            /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
