    ...
    public void setApplicationContext(final Context context) {
        ...
        this.syncInitFuture = Executors.newSingleThreadExecutor().submit(new Runnable() { // from class: com.google.firebase.perf.session.SessionManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SessionManager.this.m433xa16819e0(context, perfSession);
            }
        });
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: lambda$setApplicationContext$0$com-google-firebase-perf-session-SessionManager */
    /* synthetic */ void m433xa16819e0(Context context, PerfSession perfSession) {
