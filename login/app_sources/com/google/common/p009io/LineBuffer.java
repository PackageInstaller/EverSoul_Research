...
abstract class LineBuffer {
    ...
    */
    protected void add(char[] r7, int r8, int r9) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.p009io.LineBuffer.add(char[], int, int):void");
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private boolean finishLine(boolean z) throws IOException {
        handleLine(this.line.toString(), this.sawReturn ? z ? "\r\n" : StringUtils.f1523CR : z ? StringUtils.f1524LF : "");
