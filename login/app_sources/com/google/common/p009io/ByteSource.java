...
public abstract class ByteSource {
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (sizeIfKnown.isPresent()) {
                ...
                return Optional.m188of(Long.valueOf(Math.min(this.length, longValue - Math.min(this.offset, longValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p009io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m188of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // com.google.common.io.ByteSource.ByteArrayByteSource, com.google.common.p009io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            while (it.hasNext()) {
                ...
                if (j < 0) {
                    return Optional.m188of(Long.MAX_VALUE);
                }
            }
