...
import com.google.common.p009io.ByteSource;
import com.google.common.p009io.CharSource;
import com.google.common.p009io.Resources;
...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m196on(StringUtils.SPACE).omitEmptyStrings();
    ...
    public ImmutableSet<ClassInfo> getTopLevelClassesRecursive(String str) {
        Preconditions.checkNotNull(str);
        String sb = new StringBuilder(String.valueOf(str).length() + 1).append(str).append(ClassUtils.PACKAGE_SEPARATOR_CHAR).toString();
        ImmutableSet.Builder builder = ImmutableSet.builder();
        UnmodifiableIterator<ClassInfo> it = getTopLevelClasses().iterator();
        while (it.hasNext()) {
            ClassInfo next = it.next();
    ...
    public static class ResourceInfo {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* renamed from: of */
        static ResourceInfo m365of(File file, String str, ClassLoader classLoader) {
        ...
        private void scanJarFile(JarFile jarFile, ImmutableSet.Builder<ResourceInfo> builder) {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!nextElement.isDirectory() && !nextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    builder.add((ImmutableSet.Builder<ResourceInfo>) ResourceInfo.m365of(new File(jarFile.getName()), nextElement.getName(), this.classloader));
                }
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (!concat.equals("META-INF/MANIFEST.MF")) {
                        builder.add((ImmutableSet.Builder<ResourceInfo>) ResourceInfo.m365of(file2, concat, this.classloader));
                    }
                }
            }
        }
    ...
    static ImmutableList<URL> parseJavaClassPath() {
        ...
        for (String str : Splitter.m196on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
            try {
                try {
