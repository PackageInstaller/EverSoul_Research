...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static <B> ImmutableTypeToInstanceMap<B> m366of() {
        return new ImmutableTypeToInstanceMap<>(ImmutableMap.m234of());
    }
    ...
    public static final class Builder<B> {
        ...
        public <T extends B> Builder<B> put(Class<T> cls, T t) {
            this.mapBuilder.put(TypeToken.m368of((Class) cls), t);
            return this;
        }
    ...
    public <T extends B> T getInstance(Class<T> cls) {
        return (T) trustedGet(TypeToken.m368of((Class) cls));
    }
