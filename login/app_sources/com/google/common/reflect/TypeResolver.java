...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f424id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int incrementAndGet = this.f424id.incrementAndGet();
            String join = Joiner.m186on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f424id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
                /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f424id);
        }
