...
final class Types {
    private static final Joiner COMMA_JOINER = Joiner.m187on(", ").useForNull("null");
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            if (this.ownerType != null && JavaVersion.CURRENT.jdkTypeDuplicatesOwnerName()) {
                sb.append(JavaVersion.CURRENT.typeName(this.ownerType)).append(ClassUtils.PACKAGE_SEPARATOR_CHAR);
            }
