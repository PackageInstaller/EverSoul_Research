...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m229of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    public static final MediaType I_CALENDAR_UTF_8 = createConstantUtf8("text", Constants.TYPE_CALENDAR);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m187on("; ").withKeyValueSeparator("=");

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m228of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m188of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optional = Optional.m188of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m263of(str2));
    }
    ...
    public MediaType withCharset(Charset charset) {
        ...
        withParameter.parsedCharset = Optional.m188of(charset);
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: is */
    public boolean m340is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m228of());
