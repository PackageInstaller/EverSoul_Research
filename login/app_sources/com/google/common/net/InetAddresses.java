...
import com.google.common.p009io.ByteStreams;
...
public final class InetAddresses {
    ...
    private static final CharMatcher IPV4_DELIMITER_MATCHER = CharMatcher.m184is('.');
    private static final char IPV6_DELIMITER = ':';
    private static final CharMatcher IPV6_DELIMITER_MATCHER = CharMatcher.m184is(IPV6_DELIMITER);
    ...
    */
    ...
    private static String convertDottedQuadToHex(String str) {
        ...
        return new StringBuilder(String.valueOf(substring).length() + 1 + String.valueOf(hexString).length() + String.valueOf(hexString2).length()).append(substring).append(hexString).append(CertificateUtil.DELIMITER).append(hexString2).toString();
    }
