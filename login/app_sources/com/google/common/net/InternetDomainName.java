...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m193on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    private static final Joiner DOT_JOINER = Joiner.m186on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    ...
    static {
        ...
        CharMatcher mo185or = CharMatcher.inRange('a', 'z').mo185or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = mo185or;
        PART_CHAR_MATCHER = inRange.mo185or(mo185or).mo185or(anyOf);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    InternetDomainName(String str) {
        String lowerCase = Ascii.toLowerCase(DOTS_MATCHER.replaceFrom(str, ClassUtils.PACKAGE_SEPARATOR_CHAR));
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m188of(PublicSuffixType.REGISTRY));
    }
