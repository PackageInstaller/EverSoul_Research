...
public abstract class CaseFormat {
    ...
    public static final CaseFormat LOWER_HYPHEN = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.m184is('-'), "-") { // from class: com.google.common.base.CaseFormat.1
    ...
    static {
        String str = "_";
        LOWER_UNDERSCORE = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.m184is('_'), str) { // from class: com.google.common.base.CaseFormat.2
            /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
            @Override // com.google.common.base.CaseFormat
        ...
        UPPER_UNDERSCORE = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.m184is('_'), str) { // from class: com.google.common.base.CaseFormat.5
            /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
            @Override // com.google.common.base.CaseFormat
            String normalizeWord(String str3) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: to */
    public final String m183to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.m183to(this.targetFormat, str);
        }
        ...
        public String doBackward(String str) {
            return this.targetFormat.m183to(this.sourceFormat, str);
        }
