...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    static <N, V> UndirectedGraphConnections<N, V> m331of(ElementOrder<N> elementOrder) {
        int i = C15521.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
