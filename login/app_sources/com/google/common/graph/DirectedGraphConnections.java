...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    static <N, V> DirectedGraphConnections<N, V> m325of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i = C15325.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
