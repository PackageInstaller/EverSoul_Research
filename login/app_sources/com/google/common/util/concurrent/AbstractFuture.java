...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        String sb = new StringBuilder(String.valueOf(lowerCase2).length() + 28).append("Waited ").append(j).append(StringUtils.SPACE).append(lowerCase2).toString();
        if (nanos + 1000 < 0) {
            ...
            if (convert > 0) {
                ...
                String sb2 = new StringBuilder(String.valueOf(valueOf).length() + 21 + String.valueOf(lowerCase).length()).append(valueOf).append(convert).append(StringUtils.SPACE).append(lowerCase).toString();
                if (z) {
                    sb2 = String.valueOf(sb2).concat(",");
                }
                concat = String.valueOf(sb2).concat(StringUtils.SPACE);
            }
            if (z) {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return UByte$$ExternalSyntheticBackport0.m853m(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return UByte$$ExternalSyntheticBackport0.m853m(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }
        ...
        boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return UByte$$ExternalSyntheticBackport0.m853m(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return UByte$$ExternalSyntheticBackport0.m852m(this.waitersUpdater, abstractFuture, waiter, waiter2);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return UByte$$ExternalSyntheticBackport0.m852m(this.listenersUpdater, abstractFuture, listener, listener2);
        }
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return UByte$$ExternalSyntheticBackport0.m852m(this.valueUpdater, abstractFuture, obj, obj2);
        }
    }
