...
public abstract class Striped<L> {
    ...
    static class SmallLazyStriped<L> extends PowerOfTwoStriped<L> {
        ...
        public L getAt(int i) {
            ...
            while (!UByte$$ExternalSyntheticBackport0.m851m(this.locks, i, arrayReference, arrayReference2)) {
        ...
        private void drainQueue() {
            while (true) {
                ...
                UByte$$ExternalSyntheticBackport0.m851m(this.locks, arrayReference.index, arrayReference, (Object) null);
            }
        }
