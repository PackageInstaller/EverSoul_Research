...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (copyOf.isEmpty()) {
            ...
            copyOf = ImmutableList.m216of(new NoOpService());
        }
    ...
    private static final class ServiceManagerState {
        ...
        void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    String valueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.m189in(ImmutableSet.m264of(Service.State.NEW, Service.State.STARTING))));
        ...
        void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                String valueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.m189in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
