...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m215of(), ImmutableList.m215of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m258of() {
        return (ImmutableRangeMap<K, V>) EMPTY;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m259of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m216of(range), ImmutableList.m216of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>() { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range2) {
                ...
                return ImmutableRangeMap.m258of();
            }
        };
    }
