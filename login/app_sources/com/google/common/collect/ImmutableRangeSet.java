...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m215of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m216of(Range.all()));
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m260of() {
        return EMPTY;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m261of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m216of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> m260of = m260of();
            this.complement = m260of;
            return m260of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m310of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m260of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m216of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
