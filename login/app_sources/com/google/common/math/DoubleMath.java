...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        ...
        switch (C15911.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    */
    public static int log2(double r5, java.math.RoundingMode r7) {
        ...
        L11:
            ...
            return r5
        L2a:
            int[] r3 = com.google.common.math.DoubleMath.C15911.$SwitchMap$java$math$RoundingMode
            int r7 = r7.ordinal()
            r7 = r3[r7]
            switch(r7) {
                case 1: goto L61;
