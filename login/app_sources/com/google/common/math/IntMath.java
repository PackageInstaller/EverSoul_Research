...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, KGResult.KGResultCode.REQUEST_REOPEN, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, Http2Connection.DEGRADED_PONG_TIMEOUT_NS};
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C15921.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    */
    public static int divide(int r5, int r6, java.math.RoundingMode r7) {
        ...
        Le:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.google.common.math.IntMath.C15921.$SwitchMap$java$math$RoundingMode
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
