...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    final double roundToDouble(X x, RoundingMode roundingMode) {
        ...
        if (Double.isInfinite(roundToDoubleArbitrarily)) {
            switch (C15981.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C15981.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int i = C15981.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 2) {
