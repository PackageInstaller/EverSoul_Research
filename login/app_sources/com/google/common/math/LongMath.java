...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f345SI, Ascii.f345SI, Ascii.f345SI, Ascii.f345SI, Ascii.f346SO, Ascii.f346SO, Ascii.f346SO, Ascii.f336CR, Ascii.f336CR, Ascii.f336CR, Ascii.f338FF, Ascii.f338FF, Ascii.f338FF, Ascii.f338FF, Ascii.f349VT, Ascii.f349VT, Ascii.f349VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C15941.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    */
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L10:
            ...
            r10 = 1
            r9 = r9 | r10
            int[] r7 = com.google.common.math.LongMath.C15941.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
    ...
    public static long factorial(int i) {
        MathPreconditions.checkNonNegative(AgreementService.VALUE_NO, i);
    ...
    public static long binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(AgreementService.VALUE_NO, i);
        MathPreconditions.checkNonNegative(SingularParamsBase.Constants.IDENTIFIER_KEYSPACE_KEY, i2);
    ...
    public static boolean isPrime(long j) {
        if (j < 2) {
            MathPreconditions.checkNonNegative(AgreementService.VALUE_NO, j);
            return false;
        }
        if (j < 66) {
    ...
    private enum MillerRabinTester {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* synthetic */ MillerRabinTester(C15941 c15941) {
            this();
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (C15941.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C15941.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 6) {
                    return j >= 0 ? d2 : d;
                }
                if (i == 7) {
