...
public final class Stats implements Serializable {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static Stats m335of(Iterable<? extends Number> iterable) {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static Stats m336of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static Stats m337of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static Stats m338of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: of */
    public static Stats m339of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper(this).add(KGService.COUNT, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add(Base2ndPWViewData.KEY_MIN, this.min).add("max", this.max).toString();
        }
        return MoreObjects.toStringHelper(this).add(KGService.COUNT, this.count).toString();
    }
