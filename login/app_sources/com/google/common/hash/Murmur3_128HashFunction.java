...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f385C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f386C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f387h1;
            this.f387h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            long j3 = this.f388h2;
            this.f387h1 = ((rotateLeft + j3) * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f388h2 = mixK2;
            this.f388h2 = ((Long.rotateLeft(mixK2, 31) + this.f387h1) * 5) + 944331445;
        }
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            ...
            switch (byteBuffer.remaining()) {
                case 1:
                    ...
                    this.f387h1 ^= mixK1(j7);
                    this.f388h2 ^= mixK2(j15);
                    return;
                case 2:
                    j2 = 0;
        ...
        protected HashCode makeHash() {
            ...
            int i = this.length;
            long j2 = j ^ i;
            long j3 = this.f388h2 ^ i;
            long j4 = j2 + j3;
            this.f387h1 = j4;
            this.f388h2 = j3 + j4;
            this.f387h1 = fmix64(j4);
            long fmix64 = fmix64(this.f388h2);
            long j5 = this.f387h1 + fmix64;
            this.f387h1 = j5;
            this.f388h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f387h1).putLong(this.f388h2).array());
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private static long mixK1(long j) {
            return Long.rotateLeft(j * f385C1, 31) * f386C2;
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private static long mixK2(long j) {
            return Long.rotateLeft(j * f386C2, 33) * f385C1;
        }
    }
}
