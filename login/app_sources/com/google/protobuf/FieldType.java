...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : values) {
            VALUES[fieldType.f477id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C20181.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i3 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C20181.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }
