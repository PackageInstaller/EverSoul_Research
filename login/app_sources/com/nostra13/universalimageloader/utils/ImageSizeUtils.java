...
public final class ImageSizeUtils {
    ...
    public static int computeImageSampleSize(ImageSize imageSize, ImageSize imageSize2, ViewScaleType viewScaleType, boolean z) {
        ...
        int i = C25901.f1140x841fdc36[viewScaleType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                max = 1;
            } else if (z) {
    ...
    static /* synthetic */ class C25901 {
        ...
        static {
            ...
            try {
                f1140x841fdc36[ViewScaleType.CROP.ordinal()] = 2;
