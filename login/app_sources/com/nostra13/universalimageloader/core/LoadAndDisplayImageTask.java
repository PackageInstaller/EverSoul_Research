...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x00dc A[Catch: all -> 0x0105, TaskCancelledException -> 0x0107, Merged into TryCatch #1 {all -> 0x0105, TaskCancelledException -> 0x0107, blocks: (B:13:0x003d, B:15:0x004c, B:18:0x0053, B:20:0x00bd, B:22:0x00c5, B:24:0x00dc, B:25:0x00e7, B:29:0x0063, B:33:0x006d, B:35:0x007b, B:37:0x0092, B:39:0x009f, B:41:0x00a7, B:42:0x0107), top: B:12:0x003d }] */
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    ...
    */
    ...
    private boolean waitIfPaused() {
        ...
        if (pause.get()) {
            synchronized (this.engine.getPauseLock()) {
                if (pause.get()) {
                    C2591L.m719d(LOG_WAITING_FOR_RESUME, this.memoryCacheKey);
                    try {
                        this.engine.getPauseLock().wait();
                        C2591L.m719d(LOG_RESUME_AFTER_PAUSE, this.memoryCacheKey);
                    } catch (InterruptedException unused) {
                        C2591L.m720e(LOG_TASK_INTERRUPTED, this.memoryCacheKey);
                        return true;
                    }
                }
            }
    ...
    private boolean delayIfNeed() {
        ...
        C2591L.m719d(y.ۮڭڭܬި(862876403), Integer.valueOf(this.options.getDelayBeforeLoading()), this.memoryCacheKey);
        try {
            Thread.sleep(this.options.getDelayBeforeLoading());
            return isTaskNotActual();
        } catch (InterruptedException unused) {
            C2591L.m720e(y.ٲٴݴ״ٰ(1782516728), this.memoryCacheKey);
            return true;
        }
    }
        ...
        try {
            try {
                ...
                if (file2 == null || !file2.exists() || file2.length() <= 0) {
                    ...
                    C2591L.m719d(LOG_LOAD_IMAGE_FROM_DISK_CACHE, this.memoryCacheKey);
                ...
                C2591L.m719d(LOG_LOAD_IMAGE_FROM_NETWORK, this.memoryCacheKey);
    ...
    private boolean tryCacheImageOnDisk() throws TaskCancelledException {
        C2591L.m719d(y.֬ڱܱײٮ(-1159050175), this.memoryCacheKey);
        try {
            ...
            if (downloadImage) {
                ...
                if (i > 0 || i2 > 0) {
                    C2591L.m719d(LOG_RESIZE_CACHED_IMAGE_FILE, this.memoryCacheKey);
    ...
    private boolean downloadImage() throws IOException {
        ...
        if (stream == null) {
            C2591L.m720e(y.ݮڮֲڭܩ(-628219500), this.memoryCacheKey);
            return false;
        }
        try {
    ...
    private boolean resizeAndSaveImage(int i, int i2) throws IOException {
        ...
        if (decode != null && this.configuration.processorForDiskCache != null) {
            C2591L.m719d(y.٬ݯح׭٩(576311974), this.memoryCacheKey);
            decode = this.configuration.processorForDiskCache.process(decode);
            if (decode == null) {
                C2591L.m720e(y.دײܮڳܯ(2051216813), this.memoryCacheKey);
            }
        }
        if (decode == null) {
            return false;
    ...
    private boolean isViewCollected() {
        ...
        C2591L.m719d(y.٬ݯح׭٩(576320430), this.memoryCacheKey);
        return true;
    }
    ...
    private boolean isViewReused() {
        ...
        C2591L.m719d(y.٬ݯح׭٩(576320854), this.memoryCacheKey);
        return true;
    }
    ...
    private boolean isTaskInterrupted() {
        ...
        C2591L.m719d(y.ٲٴݴ״ٰ(1782516728), this.memoryCacheKey);
        return true;
    }
