...
public class DefaultConfigurationFactory {
    ...
    public static Executor createExecutor(int i, int i2, QueueProcessingType queueProcessingType) {
        return new ThreadPoolExecutor(i, i, 0L, TimeUnit.MILLISECONDS, (BlockingQueue<Runnable>) (queueProcessingType == QueueProcessingType.LIFO ? new LIFOLinkedBlockingDeque() : new LinkedBlockingQueue()), createThreadFactory(i2, y.٬ݯح׭٩(576320078)));
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static Executor createTaskDistributor() {
        return Executors.newCachedThreadPool(createThreadFactory(5, y.֬ڱܱײٮ(-1159042551)));
    }
    ...
    private static File createReserveDiskCacheDir(Context context) {
        ...
        File file = new File(cacheDirectory, y.ۮڭڭܬި(862871523));
