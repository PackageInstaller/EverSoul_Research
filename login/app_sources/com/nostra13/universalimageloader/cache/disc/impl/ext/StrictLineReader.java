...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f1135CR = 13;

    /* renamed from: LF */
    private static final byte f1136LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f1137in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f1137in;
        byte[] bArr = this.buf;
