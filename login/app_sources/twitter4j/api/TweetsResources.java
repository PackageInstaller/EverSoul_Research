...
public interface TweetsResources {
    ...
    Status unRetweetStatus(long j) throws TwitterException;
    ...
    UploadedMedia uploadMedia(String str, InputStream inputStream) throws TwitterException;

    UploadedMedia uploadMediaChunked(String str, InputStream inputStream) throws TwitterException;
}
