...
public interface UsersResources {
    ...
    User createMute(long j) throws TwitterException;
    ...
    User destroyMute(long j) throws TwitterException;
    ...
    IDs getMutesIDs(long j) throws TwitterException;

    PagableResponseList<User> getMutesList(long j) throws TwitterException;
    ...
    AccountSettings updateAllowDmsFrom(String str) throws TwitterException;
