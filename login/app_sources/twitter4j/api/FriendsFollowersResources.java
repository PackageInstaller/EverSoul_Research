...
public interface FriendsFollowersResources {
    ...
    IDs getFollowersIDs(long j, long j2, int i) throws TwitterException;

    IDs getFollowersIDs(String str, long j) throws TwitterException;

    IDs getFollowersIDs(String str, long j, int i) throws TwitterException;
    ...
    PagableResponseList<User> getFollowersList(long j, long j2, int i, boolean z, boolean z2) throws TwitterException;

    PagableResponseList<User> getFollowersList(String str, long j) throws TwitterException;

    PagableResponseList<User> getFollowersList(String str, long j, int i) throws TwitterException;

    PagableResponseList<User> getFollowersList(String str, long j, int i, boolean z, boolean z2) throws TwitterException;

    IDs getFriendsIDs(long j) throws TwitterException;

    IDs getFriendsIDs(long j, long j2) throws TwitterException;

    IDs getFriendsIDs(long j, long j2, int i) throws TwitterException;

    IDs getFriendsIDs(String str, long j) throws TwitterException;

    IDs getFriendsIDs(String str, long j, int i) throws TwitterException;
    ...
    PagableResponseList<User> getFriendsList(long j, long j2, int i, boolean z, boolean z2) throws TwitterException;

    PagableResponseList<User> getFriendsList(String str, long j) throws TwitterException;

    PagableResponseList<User> getFriendsList(String str, long j, int i) throws TwitterException;

    PagableResponseList<User> getFriendsList(String str, long j, int i, boolean z, boolean z2) throws TwitterException;
