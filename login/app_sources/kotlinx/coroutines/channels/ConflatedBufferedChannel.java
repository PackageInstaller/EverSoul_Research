...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2971trySendImplMj0NB7M = conflatedBufferedChannel.m2971trySendImplMj0NB7M(e, true);
        if (m2971trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2957exceptionOrNullimpl(m2971trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2971trySendImplMj0NB7M = conflatedBufferedChannel.m2971trySendImplMj0NB7M(e, true);
        if (!(m2971trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2943trySendJP2dKIU(E element) {
        return m2971trySendImplMj0NB7M(element, false);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2971trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2969trySendDropLatestMj0NB7M(element, isSendOp) : m2970trySendDropOldestJP2dKIU(element);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2969trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2943trySendJP2dKIU = super.mo2943trySendJP2dKIU(element);
        if (ChannelResult.m2963isSuccessimpl(mo2943trySendJP2dKIU) || ChannelResult.m2961isClosedimpl(mo2943trySendJP2dKIU)) {
            return mo2943trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2968successJP2dKIU(Unit.INSTANCE);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2970trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2966closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2943trySendJP2dKIU = mo2943trySendJP2dKIU(element);
        if (!(mo2943trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2943trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2957exceptionOrNullimpl(mo2943trySendJP2dKIU);
