...
@DebugMetadata(m854c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$dropWhile$1", m855f = "Deprecated.kt", m856i = {0, 1, 1, 2, 3, 4}, m857l = {181, 182, 183, 187, 188}, m858m = "invokeSuspend", m859n = {"$this$produce", "$this$produce", Constants.RequestBody.EXTRA_ATTRIBUTES_KEY, "$this$produce", "$this$produce", "$this$produce"}, m860s = {"L$0", "L$0", "L$2", "L$0", "L$0", "L$0"})
