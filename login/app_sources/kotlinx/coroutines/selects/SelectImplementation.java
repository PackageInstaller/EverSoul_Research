...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, symbol3)) {
                    if (UByte$$ExternalSyntheticBackport0.m852m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m852m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (findClause == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m852m(atomicReferenceFieldUpdater, this, obj, findClause)) {
                        this.internalResult = internalResult;
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.C2860xf491fb2a
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.C2860xf491fb2a) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public void invoke2(Throwable cause) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m852m(atomicReferenceFieldUpdater, this, obj, symbol2));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L14:
            ...
            boolean r3 = kotlin.UByte$$ExternalSyntheticBackport0.m852m(r4, r6, r3, r1)
            if (r3 == 0) goto L14
            r2 = r6
        ...
        L31:
            ...
            boolean r4 = kotlin.UByte$$ExternalSyntheticBackport0.m852m(r4, r6, r3, r5)
            if (r4 == 0) goto L14
            r4 = r3
