...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m1440constructorimpl = Result.m1440constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1440constructorimpl = Result.m1440constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m1446isFailureimpl(m1440constructorimpl) ? null : m1440constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2998dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
                /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
