...
@Metadata(m838d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m839d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlinx/coroutines/flow/SharingCommand;"}, m840k = 3, m841mv = {1, 8, 0}, m843xi = 48)
@DebugMetadata(m854c = "kotlinx.coroutines.flow.StartedLazily$command$1", m855f = "SharingStarted.kt", m856i = {}, m857l = {155}, m858m = "invokeSuspend", m859n = {}, m860s = {})
...
final class StartedLazily$command$1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$subscriptionCount.collect(new C28531(booleanRef, flowCollector), this) == coroutine_suspended) {
    ...
    /* compiled from: SharingStarted.kt */
    @Metadata(m838d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m839d2 = {"<anonymous>", "", KGService.COUNT, "", "emit", "(ILkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m840k = 3, m841mv = {1, 8, 0}, m843xi = 48)
    /* renamed from: kotlinx.coroutines.flow.StartedLazily$command$1$1 */
    static final class C28531<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<SharingCommand> $$this$flow;
        final /* synthetic */ Ref.BooleanRef $started;

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C28531(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
        ...
        */
        public final java.lang.Object emit(int r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily$command$1.C28531.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
        }
