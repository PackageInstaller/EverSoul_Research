...
@Metadata(m838d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m840k = 3, m841mv = {1, 8, 0}, m843xi = 48)
@DebugMetadata(m854c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", m855f = "Share.kt", m856i = {}, m857l = {214, 218, 219, 225}, m858m = "invokeSuspend", m859n = {}, m860s = {})
...
final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    /* compiled from: Share.kt */
    @Metadata(m838d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it", ""}, m840k = 3, m841mv = {1, 8, 0}, m843xi = 48)
    @DebugMetadata(m854c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1", m855f = "Share.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1 */
    static final class C28201 extends SuspendLambda implements Function2<Integer, Continuation<? super Boolean>, Object> {
        /* synthetic */ int I$0;
        int label;

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C28201(Continuation<? super C28201> continuation) {
            super(2, continuation);
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C28201 c28201 = new C28201(continuation);
            c28201.I$0 = ((Number) obj).intValue();
            return c28201;
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        public final Object invoke(int i, Continuation<? super Boolean> continuation) {
            return ((C28201) create(Integer.valueOf(i), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* compiled from: Share.kt */
    @Metadata(m838d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it", "Lkotlinx/coroutines/flow/SharingCommand;"}, m840k = 3, m841mv = {1, 8, 0}, m843xi = 48)
    @DebugMetadata(m854c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", m855f = "Share.kt", m856i = {}, m857l = {227}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2 */
    static final class C28212 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $initialValue;
        final /* synthetic */ MutableSharedFlow<T> $shared;
        final /* synthetic */ Flow<T> $upstream;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C28212(Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, T t, Continuation<? super C28212> continuation) {
            super(2, continuation);
            this.$upstream = flow;
            this.$shared = mutableSharedFlow;
            this.$initialValue = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C28212 c28212 = new C28212(this.$upstream, this.$shared, this.$initialValue, continuation);
            c28212.L$0 = obj;
            return c28212;
        }
        ...
        public final Object invoke(SharingCommand sharingCommand, Continuation<? super Unit> continuation) {
            return ((C28212) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
