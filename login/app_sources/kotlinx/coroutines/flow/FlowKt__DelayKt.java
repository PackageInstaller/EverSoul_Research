...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2976debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2930toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m2930toDelayMillisLRDsOJo(function1.invoke(t).m2820unboximpl()));
            }
        });
    }
    ...
    public static final <T> Flow<T> m2977sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2930toDelayMillisLRDsOJo(j));
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m2978timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2979timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m2979timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
