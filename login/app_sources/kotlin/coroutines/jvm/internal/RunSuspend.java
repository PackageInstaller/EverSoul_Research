...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2657getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m1439boximpl(result);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result == null) {
                    ...
                    ResultKt.throwOnFailure(result.m1449unboximpl());
                }
            }
        }
    }
