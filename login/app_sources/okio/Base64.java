...
@Metadata(m837bv = {1, 0, 3}, m838d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0003\u001a\u000e\u0010\u0006\u001a\u0004\u0018\u00010\u0001*\u00020\u0007H\u0000\u001a\u0016\u0010\b\u001a\u00020\u0007*\u00020\u00012\b\b\u0002\u0010\t\u001a\u00020\u0001H\u0000\"\u0014\u0010\u0000\u001a\u00020\u0001X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0003\"\u0014\u0010\u0004\u001a\u00020\u0001X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0003¨\u0006\n"}, m839d2 = {"BASE64", "", "getBASE64", "()[B", "BASE64_URL_SAFE", "getBASE64_URL_SAFE", "decodeBase64ToArray", "", "encodeBase64", "map", "okio"}, m840k = 2, m841mv = {1, 4, 0})
...
public final class Base64 {
    ...
    public static final String encodeBase64(byte[] encodeBase64, byte[] map) {
        ...
        while (i < length) {
            ...
            int i8 = i7 + 1;
            bArr[i7] = map[((b2 & Ascii.f345SI) << 2) | ((b3 & 255) >> 6)];
            i2 = i8 + 1;
        ...
        if (length2 == 1) {
            ...
            bArr[i13] = map[(b7 & Ascii.f345SI) << 2];
            bArr[i13 + 1] = (byte) 61;
        }
