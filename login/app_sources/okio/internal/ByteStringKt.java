...
public final class ByteStringKt {
    ...
    public static final String commonHex(ByteString commonHex) {
        ...
        for (byte b : commonHex.getData$okio()) {
            ...
            i = i2 + 1;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & Ascii.f345SI];
        }
