...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m838d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it"}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
    @DebugMetadata(m854c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m855f = "SharedPreferencesMigration.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$1 */
    static final class C02841 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02841(continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02841) obj, continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02841) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02841 c02841, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C02841(null) : c02841, function3, context, str);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m838d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it"}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
    @DebugMetadata(m854c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m855f = "SharedPreferencesMigration.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$2 */
    public static final class C02852 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C02852(Continuation<? super C02852> continuation) {
            super(2, continuation);
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02852(continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02852) obj, continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02852) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C02852 c02852, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C02852(null) : c02852, function3);
    }
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m838d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it"}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
    @DebugMetadata(m854c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m855f = "SharedPreferencesMigration.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: androidx.datastore.migrations.SharedPreferencesMigration$3 */
    public static final class C02863 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C02863(Continuation<? super C02863> continuation) {
            super(2, continuation);
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C02863(continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
            return invoke2((C02863) obj, continuation);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final Object invoke2(T t, Continuation<? super Boolean> continuation) {
            return ((C02863) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C02863 c02863, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C02863(null) : c02863, function3);
    }
    ...
    */
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(m838d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m839d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", "name", "", "datastore_release"}, m840k = 1, m841mv = {1, 5, 1}, m843xi = 48)
