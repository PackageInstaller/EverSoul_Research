...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C03171 c03171) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C03171) null);
    }
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C03171.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 7:
    ...
    static void writeElementNoTag(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, Object obj) throws IOException {
        switch (C03171.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* synthetic */ Builder(C03171 c03171) {
            this();
        }
