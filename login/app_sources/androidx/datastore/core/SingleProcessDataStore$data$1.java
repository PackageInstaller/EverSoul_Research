...
@Metadata(m838d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;"}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
@DebugMetadata(m854c = "androidx.datastore.core.SingleProcessDataStore$data$1", m855f = "SingleProcessDataStore.kt", m856i = {}, m857l = {117}, m858m = "invokeSuspend", m859n = {}, m860s = {})
...
final class SingleProcessDataStore$data$1<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final Flow dropWhile = FlowKt.dropWhile(mutableStateFlow2, new C02821(state, null));
            this.label = 1;
            if (FlowKt.emitAll(flowCollector, new Flow<T>() { // from class: androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1
                ...
                @Metadata(m838d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\b"}, m839d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collect$3", "Lkotlinx/coroutines/flow/FlowCollector;", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core", "kotlinx/coroutines/flow/FlowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$1", "kotlinx/coroutines/flow/FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2"}, m840k = 1, m841mv = {1, 5, 1}, m843xi = 48)
                /* renamed from: androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1$2 */
                public static final class C02812 implements FlowCollector<State<T>> {
                    final /* synthetic */ FlowCollector $this_unsafeFlow$inlined;

                    @Metadata(m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
                    @DebugMetadata(m854c = "androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1$2", m855f = "SingleProcessDataStore.kt", m856i = {}, m857l = {137}, m858m = "emit", m859n = {}, m860s = {})
                    ...
                    public static final class AnonymousClass1 extends ContinuationImpl {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            return C02812.this.emit(null, this);
                        }
                    }

                    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
                    public C02812(FlowCollector flowCollector) {
                    ...
                    */
                    public java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                        /*
                            r4 = this;
                            boolean r0 = r6 instanceof androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1.C02812.AnonymousClass1
                            if (r0 == 0) goto L14
                            r0 = r6
                            androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1$2$1 r0 = (androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1.C02812.AnonymousClass1) r0
                            int r1 = r0.label
                        ...
                        */
                        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1.C02812.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                    }
                }
                ...
                public Object collect(FlowCollector flowCollector2, Continuation continuation) {
                    Object collect = Flow.this.collect(new C02812(flowCollector2), continuation);
    ...
    /* compiled from: SingleProcessDataStore.kt */
    @Metadata(m838d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@"}, m839d2 = {"<anonymous>", "", "T", "it", "Landroidx/datastore/core/State;"}, m840k = 3, m841mv = {1, 5, 1}, m843xi = 48)
    @DebugMetadata(m854c = "androidx.datastore.core.SingleProcessDataStore$data$1$1", m855f = "SingleProcessDataStore.kt", m856i = {}, m857l = {}, m858m = "invokeSuspend", m859n = {}, m860s = {})
    /* renamed from: androidx.datastore.core.SingleProcessDataStore$data$1$1 */
    static final class C02821 extends SuspendLambda implements Function2<State<T>, Continuation<? super Boolean>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        C02821(State<T> state, Continuation<? super C02821> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02821 c02821 = new C02821(this.$currentDownStreamFlowState, continuation);
            c02821.L$0 = obj;
            return c02821;
        }
        ...
        public final Object invoke(State<T> state, Continuation<? super Boolean> continuation) {
            return ((C02821) create(state, continuation)).invokeSuspend(Unit.INSTANCE);
        }
