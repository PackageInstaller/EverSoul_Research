...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(Predicate<String> predicate) {
            ...
            this.mAllowedActions = this.mAllowedActions.m36or(predicate);
            return this;
        }
        ...
        public Builder allowData(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.m36or(predicate);
            return this;
        }
        ...
        public Builder allowType(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m36or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m36or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m36or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m36or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m36or(predicate);
            return this;
        }
        ...
        public Builder allowClipData(Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m36or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            this.mAllowedExtras.put(str, predicate2.m36or(predicate));
            return this;
        }
