...
public class ShortcutManagerCompat {
    ...
    private static ShortcutInfoCompatSaver<?> getShortcutInfoSaverInstance(Context context) {
        if (sShortcutInfoCompatSaver == null) {
            try {
                sShortcutInfoCompatSaver = (ShortcutInfoCompatSaver) Class.forName("androidx.sharetarget.ShortcutInfoCompatSaverImpl", false, ShortcutManagerCompat.class.getClassLoader()).getMethod(Constants.APP_LIFECYCLE_OBSERVER_SINGLETON_METHOD, Context.class).invoke(null, context);
            } catch (Exception unused) {
            }
            if (sShortcutInfoCompatSaver == null) {
        ...
        if (sShortcutInfoChangeListeners == null) {
            ...
            while (it.hasNext()) {
                ...
                if (activityInfo != null && (bundle = activityInfo.metaData) != null && (string = bundle.getString(SHORTCUT_LISTENER_META_DATA_KEY)) != null) {
                    try {
                        arrayList.add((ShortcutInfoChangeListener) Class.forName(string, false, ShortcutManagerCompat.class.getClassLoader()).getMethod(Constants.APP_LIFECYCLE_OBSERVER_SINGLETON_METHOD, Context.class).invoke(null, context));
                    } catch (Exception unused) {
                    }
                }
            }
