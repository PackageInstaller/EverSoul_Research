...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f70id, this.tag, this.notif);
        }
        ...
        public String toString() {
            ...
            sb.append(", id:").append(this.f70id);
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f69id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            sb.append(this.packageName);
            sb.append(", id:").append(this.f69id);
            sb.append(", tag:").append(this.tag);
