...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0211R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0211R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0211R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0211R.id.notification_main_column);
            remoteViews.addView(C0211R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0211R.id.notification_main_column, 0);
            Api16Impl.setViewPadding(remoteViews, C0211R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0211R.id.title, 8);
            remoteViews.setViewVisibility(C0211R.id.text2, 8);
            remoteViews.setViewVisibility(C0211R.id.text, 8);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0211R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0211R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0211R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0211R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0211R.string.call_notification_screening_text);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private Action makeNegativeAction() {
            int i = C0211R.drawable.ic_call_decline_low;
            int i2 = C0211R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C0211R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0211R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C0211R.string.call_notification_decline_action, this.mDeclineButtonColor, C0211R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        private Action makeAnswerAction() {
            int i;
            int i2 = C0211R.drawable.ic_call_answer_video_low;
            int i3 = C0211R.drawable.ic_call_answer_low;
            int i4 = C0211R.drawable.ic_call_answer_video;
            int i5 = C0211R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C0211R.string.call_notification_answer_video_action;
            } else {
                i = C0211R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C0211R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0211R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0211R.id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0211R.id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0211R.id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0211R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0211R.layout.notification_action_tombstone;
            } else {
                i = C0211R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0211R.id.action_image, createColoredBitmap(iconCompat, C0211R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0211R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0211R.id.action_container, action.actionIntent);
            }
            Api15Impl.setContentDescription(remoteViews, C0211R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m915clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m916clone() {
            WearableExtender wearableExtender = new WearableExtender();
