...
public class ConstraintAttribute {
    ...
    public boolean isContinuous() {
        int i = C02051.f63x66adad53[this.mType.ordinal()];
    ...
    public void setValue(float[] value) {
        switch (C02051.f63x66adad53[this.mType.ordinal()]) {
            case 1:
            case 6:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            try {
                switch (C02051.f63x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static void parse(Context context, XmlPullParser parser, HashMap<String, ConstraintAttribute> custom2) {
        AttributeType attributeType;
        Object valueOf;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0207R.styleable.CustomAttribute);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0207R.styleable.CustomAttribute_attributeName) {
            ...
            } else if (index == C0207R.styleable.CustomAttribute_methodName) {
                str = obtainStyledAttributes.getString(index);
                z = true;
                ...
                } else if (index == C0207R.styleable.CustomAttribute_customReference) {
        ...
        if (str != null && obj != null) {
            custom2.put(str, new ConstraintAttribute(str, attributeType2, obj, z));
        }
