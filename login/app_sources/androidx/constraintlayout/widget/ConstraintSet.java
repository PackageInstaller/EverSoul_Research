...
public class ConstraintSet {
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    static {
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        mapToConstant.append(C0207R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0207R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0207R.styleable.Constraint_guidelineUseRtl, 99);
        mapToConstant.append(C0207R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0207R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0207R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHeight, 96);
        mapToConstant.append(C0207R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0207R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0207R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0207R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0207R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0207R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0207R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0207R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0207R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0207R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0207R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0207R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0207R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0207R.styleable.Constraint_animateRelativeTo, 64);
        mapToConstant.append(C0207R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0207R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0207R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0207R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0207R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0207R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0207R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        mapToConstant.append(C0207R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0207R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0207R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0207R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0207R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0207R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0207R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constrainedHeight, 81);
        mapToConstant.append(C0207R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C0207R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C0207R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C0207R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C0207R.styleable.Constraint_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_motionTarget, 98);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0207R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    */
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0207R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0207R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0207R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0207R.styleable.Layout_guidelineUseRtl, 90);
            mapToConstant.append(C0207R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0207R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintLeft_creator, 91);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintTop_creator, 91);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintRight_creator, 91);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBottom_creator, 91);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBaseline_creator, 91);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0207R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0207R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0207R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0207R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0207R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0207R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0207R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0207R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0207R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0207R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0207R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0207R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0207R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0207R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0207R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0207R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0207R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0207R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0207R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0207R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0207R.styleable.Transform_android_elevation, 11);
            mapToConstant.append(C0207R.styleable.Transform_transformPivotTarget, 12);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0207R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0207R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0207R.styleable.PropertySet_android_alpha) {
                    this.alpha = obtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0207R.styleable.PropertySet_android_visibility) {
                    this.visibility = obtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0207R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = obtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0207R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0207R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0207R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0207R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0207R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0207R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0207R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0207R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0207R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0207R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0207R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, C0207R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m914clone());
            }
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? C0207R.styleable.ConstraintOverride : C0207R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0207R.styleable.ConstraintOverride);
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static void populateOverride(Context ctx, Constraint c, TypedArray a2) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                case 2:
                    delta.add(2, a2.getDimensionPixelSize(index, c.layout.bottomMargin));
                    break;
                case 3:
                case 4:
                case 9:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    delta.add(6, a2.getDimensionPixelOffset(index, c.layout.editorAbsoluteX));
                    break;
                case 7:
                    delta.add(7, a2.getDimensionPixelOffset(index, c.layout.editorAbsoluteY));
                    break;
                case 8:
                    delta.add(8, a2.getDimensionPixelSize(index, c.layout.endMargin));
                    break;
                case 11:
                    delta.add(11, a2.getDimensionPixelSize(index, c.layout.goneBottomMargin));
                    break;
                case 12:
                    delta.add(12, a2.getDimensionPixelSize(index, c.layout.goneEndMargin));
                    break;
                case 13:
                    delta.add(13, a2.getDimensionPixelSize(index, c.layout.goneLeftMargin));
                    break;
                case 14:
                    delta.add(14, a2.getDimensionPixelSize(index, c.layout.goneRightMargin));
                    break;
                case 15:
                    delta.add(15, a2.getDimensionPixelSize(index, c.layout.goneStartMargin));
                    break;
                case 16:
                    delta.add(16, a2.getDimensionPixelSize(index, c.layout.goneTopMargin));
                    break;
                case 17:
                    delta.add(17, a2.getDimensionPixelOffset(index, c.layout.guideBegin));
                    break;
                case 18:
                    delta.add(18, a2.getDimensionPixelOffset(index, c.layout.guideEnd));
                    break;
                case 19:
                    delta.add(19, a2.getFloat(index, c.layout.guidePercent));
                    break;
                case 20:
                    delta.add(20, a2.getFloat(index, c.layout.horizontalBias));
                    break;
                case 21:
                    delta.add(21, a2.getLayoutDimension(index, c.layout.mHeight));
                    break;
                case 22:
                    delta.add(22, VISIBILITY_FLAGS[a2.getInt(index, c.propertySet.visibility)]);
                    break;
                case 23:
                    delta.add(23, a2.getLayoutDimension(index, c.layout.mWidth));
                    break;
                case 24:
                    delta.add(24, a2.getDimensionPixelSize(index, c.layout.leftMargin));
                    break;
                case 27:
                    delta.add(27, a2.getInt(index, c.layout.orientation));
                    break;
                case 28:
                    delta.add(28, a2.getDimensionPixelSize(index, c.layout.rightMargin));
                    break;
                case 31:
                    delta.add(31, a2.getDimensionPixelSize(index, c.layout.startMargin));
                    break;
                case 34:
                    delta.add(34, a2.getDimensionPixelSize(index, c.layout.topMargin));
                    break;
                case 37:
                    delta.add(37, a2.getFloat(index, c.layout.verticalBias));
                    break;
                case 38:
                    c.mViewId = a2.getResourceId(index, c.mViewId);
                    delta.add(38, c.mViewId);
                    break;
                case 39:
                    delta.add(39, a2.getFloat(index, c.layout.horizontalWeight));
                    break;
                case 40:
                    delta.add(40, a2.getFloat(index, c.layout.verticalWeight));
                    break;
                case 41:
                    delta.add(41, a2.getInt(index, c.layout.horizontalChainStyle));
                    break;
                case 42:
                    delta.add(42, a2.getInt(index, c.layout.verticalChainStyle));
                    break;
                case 43:
                    delta.add(43, a2.getFloat(index, c.propertySet.alpha));
                    break;
                case 44:
                    delta.add(44, true);
                    delta.add(44, a2.getDimension(index, c.transform.elevation));
                    break;
                case 45:
                    delta.add(45, a2.getFloat(index, c.transform.rotationX));
                    break;
                case 46:
                    delta.add(46, a2.getFloat(index, c.transform.rotationY));
                    break;
                case 47:
                    delta.add(47, a2.getFloat(index, c.transform.scaleX));
                    break;
                case 48:
                    delta.add(48, a2.getFloat(index, c.transform.scaleY));
                    break;
                case 49:
                    delta.add(49, a2.getDimension(index, c.transform.transformPivotX));
                    break;
                case 50:
                    delta.add(50, a2.getDimension(index, c.transform.transformPivotY));
                    break;
                case 51:
                    delta.add(51, a2.getDimension(index, c.transform.translationX));
                    break;
                case 52:
                    delta.add(52, a2.getDimension(index, c.transform.translationY));
                    break;
                case 53:
                    delta.add(53, a2.getDimension(index, c.transform.translationZ));
                    break;
                case 54:
                    delta.add(54, a2.getInt(index, c.layout.widthDefault));
                    break;
                case 55:
                    delta.add(55, a2.getInt(index, c.layout.heightDefault));
                    break;
                case 56:
                    delta.add(56, a2.getDimensionPixelSize(index, c.layout.widthMax));
                    break;
                case 57:
                    delta.add(57, a2.getDimensionPixelSize(index, c.layout.heightMax));
                    break;
                case 58:
                    delta.add(58, a2.getDimensionPixelSize(index, c.layout.widthMin));
                    break;
                case 59:
                    delta.add(59, a2.getDimensionPixelSize(index, c.layout.heightMin));
                    break;
                case 60:
                    delta.add(60, a2.getFloat(index, c.transform.rotation));
                    break;
                case 62:
                    delta.add(62, a2.getDimensionPixelSize(index, c.layout.circleRadius));
                    break;
                case 63:
                    delta.add(63, a2.getFloat(index, c.layout.circleAngle));
                    break;
                case 64:
                    delta.add(64, lookupID(a2, index, c.motion.mAnimateRelativeTo));
                    break;
                case 65:
                ...
                case 66:
                    ...
                    break;
                case 67:
                    delta.add(67, a2.getFloat(index, c.motion.mPathRotate));
                    break;
                case 68:
                    delta.add(68, a2.getFloat(index, c.propertySet.mProgress));
                    break;
                case 69:
                ...
                case 71:
                    ...
                    break;
                case 72:
                    delta.add(72, a2.getInt(index, c.layout.mBarrierDirection));
                    break;
                case 73:
                    delta.add(73, a2.getDimensionPixelSize(index, c.layout.mBarrierMargin));
                    break;
                case 74:
                    delta.add(74, a2.getString(index));
                    break;
                case 75:
                    delta.add(75, a2.getBoolean(index, c.layout.mBarrierAllowsGoneWidgets));
                    break;
                case 76:
                    delta.add(76, a2.getInt(index, c.motion.mPathMotionArc));
                    break;
                case 77:
                    delta.add(77, a2.getString(index));
                    break;
                case 78:
                    delta.add(78, a2.getInt(index, c.propertySet.mVisibilityMode));
                    break;
                case 79:
                    delta.add(79, a2.getFloat(index, c.motion.mMotionStagger));
                    break;
                case 80:
                    delta.add(80, a2.getBoolean(index, c.layout.constrainedWidth));
                    break;
                case 81:
                    delta.add(81, a2.getBoolean(index, c.layout.constrainedHeight));
                    break;
                case 82:
                    delta.add(82, a2.getInteger(index, c.motion.mAnimateCircleAngleTo));
                    break;
                case 83:
                    delta.add(83, lookupID(a2, index, c.transform.transformPivotTarget));
                    break;
                case 84:
                    delta.add(84, a2.getInteger(index, c.motion.mQuantizeMotionSteps));
                    break;
                case 85:
                    delta.add(85, a2.getFloat(index, c.motion.mQuantizeMotionPhase));
                    break;
                case 86:
                    TypedValue peekValue = a2.peekValue(index);
                    if (peekValue.type == 1) {
                        c.motion.mQuantizeInterpolatorID = a2.getResourceId(index, -1);
                        ...
                        c.motion.mQuantizeInterpolatorString = a2.getString(index);
                        ...
                        c.motion.mQuantizeInterpolatorType = a2.getInteger(index, c.motion.mQuantizeInterpolatorID);
                        delta.add(88, c.motion.mQuantizeInterpolatorType);
                        break;
                    }
                case 87:
                    ...
                    break;
                case 93:
                    delta.add(93, a2.getDimensionPixelSize(index, c.layout.baselineMargin));
                    break;
                case 94:
                    delta.add(94, a2.getDimensionPixelSize(index, c.layout.goneBaselineMargin));
                    break;
                case 95:
                ...
                case 96:
                    ...
                    break;
                case 97:
                    delta.add(97, a2.getInt(index, c.layout.mWrapBehavior));
                    break;
                case 98:
                ...
                case 99:
                    delta.add(99, a2.getBoolean(index, c.layout.guidelineUseRtl));
                    break;
            }
        }
    }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private void populateConstraint(Context ctx, Constraint c, TypedArray a2, boolean override) {
        if (override) {
            populateOverride(ctx, c, a2);
            return;
        }
        int indexCount = a2.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = a2.getIndex(i);
            if (index != C0207R.styleable.Constraint_android_id && C0207R.styleable.Constraint_android_layout_marginStart != index && C0207R.styleable.Constraint_android_layout_marginEnd != index) {
            ...
            switch (mapToConstant.get(index)) {
                case 1:
                    c.layout.baselineToBaseline = lookupID(a2, index, c.layout.baselineToBaseline);
                    break;
                case 2:
                    c.layout.bottomMargin = a2.getDimensionPixelSize(index, c.layout.bottomMargin);
                    break;
                case 3:
                    c.layout.bottomToBottom = lookupID(a2, index, c.layout.bottomToBottom);
                    break;
                case 4:
                    c.layout.bottomToTop = lookupID(a2, index, c.layout.bottomToTop);
                    break;
                case 5:
                    c.layout.dimensionRatio = a2.getString(index);
                    break;
                case 6:
                    c.layout.editorAbsoluteX = a2.getDimensionPixelOffset(index, c.layout.editorAbsoluteX);
                    break;
                case 7:
                    c.layout.editorAbsoluteY = a2.getDimensionPixelOffset(index, c.layout.editorAbsoluteY);
                    break;
                case 8:
                    c.layout.endMargin = a2.getDimensionPixelSize(index, c.layout.endMargin);
                    break;
                case 9:
                    c.layout.endToEnd = lookupID(a2, index, c.layout.endToEnd);
                    break;
                case 10:
                    c.layout.endToStart = lookupID(a2, index, c.layout.endToStart);
                    break;
                case 11:
                    c.layout.goneBottomMargin = a2.getDimensionPixelSize(index, c.layout.goneBottomMargin);
                    break;
                case 12:
                    c.layout.goneEndMargin = a2.getDimensionPixelSize(index, c.layout.goneEndMargin);
                    break;
                case 13:
                    c.layout.goneLeftMargin = a2.getDimensionPixelSize(index, c.layout.goneLeftMargin);
                    break;
                case 14:
                    c.layout.goneRightMargin = a2.getDimensionPixelSize(index, c.layout.goneRightMargin);
                    break;
                case 15:
                    c.layout.goneStartMargin = a2.getDimensionPixelSize(index, c.layout.goneStartMargin);
                    break;
                case 16:
                    c.layout.goneTopMargin = a2.getDimensionPixelSize(index, c.layout.goneTopMargin);
                    break;
                case 17:
                    c.layout.guideBegin = a2.getDimensionPixelOffset(index, c.layout.guideBegin);
                    break;
                case 18:
                    c.layout.guideEnd = a2.getDimensionPixelOffset(index, c.layout.guideEnd);
                    break;
                case 19:
                    c.layout.guidePercent = a2.getFloat(index, c.layout.guidePercent);
                    break;
                case 20:
                    c.layout.horizontalBias = a2.getFloat(index, c.layout.horizontalBias);
                    break;
                case 21:
                    c.layout.mHeight = a2.getLayoutDimension(index, c.layout.mHeight);
                    break;
                case 22:
                    c.propertySet.visibility = a2.getInt(index, c.propertySet.visibility);
                    c.propertySet.visibility = VISIBILITY_FLAGS[c.propertySet.visibility];
                    break;
                case 23:
                    c.layout.mWidth = a2.getLayoutDimension(index, c.layout.mWidth);
                    break;
                case 24:
                    c.layout.leftMargin = a2.getDimensionPixelSize(index, c.layout.leftMargin);
                    break;
                case 25:
                    c.layout.leftToLeft = lookupID(a2, index, c.layout.leftToLeft);
                    break;
                case 26:
                    c.layout.leftToRight = lookupID(a2, index, c.layout.leftToRight);
                    break;
                case 27:
                    c.layout.orientation = a2.getInt(index, c.layout.orientation);
                    break;
                case 28:
                    c.layout.rightMargin = a2.getDimensionPixelSize(index, c.layout.rightMargin);
                    break;
                case 29:
                    c.layout.rightToLeft = lookupID(a2, index, c.layout.rightToLeft);
                    break;
                case 30:
                    c.layout.rightToRight = lookupID(a2, index, c.layout.rightToRight);
                    break;
                case 31:
                    c.layout.startMargin = a2.getDimensionPixelSize(index, c.layout.startMargin);
                    break;
                case 32:
                    c.layout.startToEnd = lookupID(a2, index, c.layout.startToEnd);
                    break;
                case 33:
                    c.layout.startToStart = lookupID(a2, index, c.layout.startToStart);
                    break;
                case 34:
                    c.layout.topMargin = a2.getDimensionPixelSize(index, c.layout.topMargin);
                    break;
                case 35:
                    c.layout.topToBottom = lookupID(a2, index, c.layout.topToBottom);
                    break;
                case 36:
                    c.layout.topToTop = lookupID(a2, index, c.layout.topToTop);
                    break;
                case 37:
                    c.layout.verticalBias = a2.getFloat(index, c.layout.verticalBias);
                    break;
                case 38:
                    c.mViewId = a2.getResourceId(index, c.mViewId);
                    break;
                case 39:
                    c.layout.horizontalWeight = a2.getFloat(index, c.layout.horizontalWeight);
                    break;
                case 40:
                    c.layout.verticalWeight = a2.getFloat(index, c.layout.verticalWeight);
                    break;
                case 41:
                    c.layout.horizontalChainStyle = a2.getInt(index, c.layout.horizontalChainStyle);
                    break;
                case 42:
                    c.layout.verticalChainStyle = a2.getInt(index, c.layout.verticalChainStyle);
                    break;
                case 43:
                    c.propertySet.alpha = a2.getFloat(index, c.propertySet.alpha);
                    break;
                case 44:
                    c.transform.applyElevation = true;
                    c.transform.elevation = a2.getDimension(index, c.transform.elevation);
                    break;
                case 45:
                    c.transform.rotationX = a2.getFloat(index, c.transform.rotationX);
                    break;
                case 46:
                    c.transform.rotationY = a2.getFloat(index, c.transform.rotationY);
                    break;
                case 47:
                    c.transform.scaleX = a2.getFloat(index, c.transform.scaleX);
                    break;
                case 48:
                    c.transform.scaleY = a2.getFloat(index, c.transform.scaleY);
                    break;
                case 49:
                    c.transform.transformPivotX = a2.getDimension(index, c.transform.transformPivotX);
                    break;
                case 50:
                    c.transform.transformPivotY = a2.getDimension(index, c.transform.transformPivotY);
                    break;
                case 51:
                    c.transform.translationX = a2.getDimension(index, c.transform.translationX);
                    break;
                case 52:
                    c.transform.translationY = a2.getDimension(index, c.transform.translationY);
                    break;
                case 53:
                    c.transform.translationZ = a2.getDimension(index, c.transform.translationZ);
                    break;
                case 54:
                    c.layout.widthDefault = a2.getInt(index, c.layout.widthDefault);
                    break;
                case 55:
                    c.layout.heightDefault = a2.getInt(index, c.layout.heightDefault);
                    break;
                case 56:
                    c.layout.widthMax = a2.getDimensionPixelSize(index, c.layout.widthMax);
                    break;
                case 57:
                    c.layout.heightMax = a2.getDimensionPixelSize(index, c.layout.heightMax);
                    break;
                case 58:
                    c.layout.widthMin = a2.getDimensionPixelSize(index, c.layout.widthMin);
                    break;
                case 59:
                    c.layout.heightMin = a2.getDimensionPixelSize(index, c.layout.heightMin);
                    break;
                case 60:
                    c.transform.rotation = a2.getFloat(index, c.transform.rotation);
                    break;
                case 61:
                    c.layout.circleConstraint = lookupID(a2, index, c.layout.circleConstraint);
                    break;
                case 62:
                    c.layout.circleRadius = a2.getDimensionPixelSize(index, c.layout.circleRadius);
                    break;
                case 63:
                    c.layout.circleAngle = a2.getFloat(index, c.layout.circleAngle);
                    break;
                case 64:
                    c.motion.mAnimateRelativeTo = lookupID(a2, index, c.motion.mAnimateRelativeTo);
                    break;
                case 65:
                    if (a2.peekValue(index).type == 3) {
                        c.motion.mTransitionEasing = a2.getString(index);
                        break;
                    } else {
                        c.motion.mTransitionEasing = Easing.NAMED_EASING[a2.getInteger(index, 0)];
                        break;
                    }
                case 66:
                    c.motion.mDrawPath = a2.getInt(index, 0);
                    break;
                case 67:
                    c.motion.mPathRotate = a2.getFloat(index, c.motion.mPathRotate);
                    break;
                case 68:
                    c.propertySet.mProgress = a2.getFloat(index, c.propertySet.mProgress);
                    break;
                case 69:
                    c.layout.widthPercent = a2.getFloat(index, 1.0f);
                    break;
                case 70:
                    c.layout.heightPercent = a2.getFloat(index, 1.0f);
                    break;
                case 71:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    c.layout.mBarrierDirection = a2.getInt(index, c.layout.mBarrierDirection);
                    break;
                case 73:
                    c.layout.mBarrierMargin = a2.getDimensionPixelSize(index, c.layout.mBarrierMargin);
                    break;
                case 74:
                    c.layout.mReferenceIdString = a2.getString(index);
                    break;
                case 75:
                    c.layout.mBarrierAllowsGoneWidgets = a2.getBoolean(index, c.layout.mBarrierAllowsGoneWidgets);
                    break;
                case 76:
                    c.motion.mPathMotionArc = a2.getInt(index, c.motion.mPathMotionArc);
                    break;
                case 77:
                    c.layout.mConstraintTag = a2.getString(index);
                    break;
                case 78:
                    c.propertySet.mVisibilityMode = a2.getInt(index, c.propertySet.mVisibilityMode);
                    break;
                case 79:
                    c.motion.mMotionStagger = a2.getFloat(index, c.motion.mMotionStagger);
                    break;
                case 80:
                    c.layout.constrainedWidth = a2.getBoolean(index, c.layout.constrainedWidth);
                    break;
                case 81:
                    c.layout.constrainedHeight = a2.getBoolean(index, c.layout.constrainedHeight);
                    break;
                case 82:
                    c.motion.mAnimateCircleAngleTo = a2.getInteger(index, c.motion.mAnimateCircleAngleTo);
                    break;
                case 83:
                    c.transform.transformPivotTarget = lookupID(a2, index, c.transform.transformPivotTarget);
                    break;
                case 84:
                    c.motion.mQuantizeMotionSteps = a2.getInteger(index, c.motion.mQuantizeMotionSteps);
                    break;
                case 85:
                    c.motion.mQuantizeMotionPhase = a2.getFloat(index, c.motion.mQuantizeMotionPhase);
                    break;
                case 86:
                    TypedValue peekValue = a2.peekValue(index);
                    if (peekValue.type == 1) {
                ...
                default:
                    ...
                    break;
                case 91:
                    c.layout.baselineToTop = lookupID(a2, index, c.layout.baselineToTop);
                    break;
                case 92:
                    c.layout.baselineToBottom = lookupID(a2, index, c.layout.baselineToBottom);
                    break;
                case 93:
                    c.layout.baselineMargin = a2.getDimensionPixelSize(index, c.layout.baselineMargin);
                    break;
                case 94:
                    c.layout.goneBaselineMargin = a2.getDimensionPixelSize(index, c.layout.goneBaselineMargin);
                    break;
                case 95:
                    parseDimensionConstraints(c.layout, a2, index, 0);
                    break;
                case 96:
                    parseDimensionConstraints(c.layout, a2, index, 1);
                    break;
                case 97:
                    c.layout.mWrapBehavior = a2.getInt(index, c.layout.mWrapBehavior);
                    break;
            }
        }
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0207R.id.class.getField(trim).getInt(null);
    ...
    class WriteXmlEngine {
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            this.writer.write(CertificateUtil.DELIMITER);
            this.writer.write(", " + value);
            this.writer.write(StringUtils.f1524LF);
        }
    }
