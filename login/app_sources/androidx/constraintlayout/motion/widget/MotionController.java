...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f60x;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getStartY() {
        return this.mStartMotionPath.f61y;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getFinalX() {
        return this.mEndMotionPath.f60x;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getFinalY() {
        return this.mEndMotionPath.f61y;
    }
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f60x;
        rectF.top = this.mStartMotionPath.f61y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f60x;
        rectF2.top = this.mEndMotionPath.f61y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f60x - this.mStartMotionPath.f60x;
        float f2 = this.mEndMotionPath.f61y - this.mStartMotionPath.f61y;
        float f3 = this.mStartMotionPath.f60x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f61y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                ...
                dArr6[i17][0] = motionPathsArr[i17].f60x;
                dArr6[i17][1] = motionPathsArr[i17].f61y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f60x + " y: " + this.mStartMotionPath.f61y + " end: x: " + this.mEndMotionPath.f60x + " y: " + this.mEndMotionPath.f61y;
    }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f5 = this.mStartMotionPath.f60x + ((this.mEndMotionPath.f60x - this.mStartMotionPath.f60x) * f4);
            float f6 = f5 + 0.5f;
            int i4 = (int) f6;
            float f7 = this.mStartMotionPath.f61y + ((this.mEndMotionPath.f61y - this.mStartMotionPath.f61y) * f4) + 0.5f;
            int i5 = (int) f7;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f60x - this.mStartMotionPath.f60x;
        float f3 = this.mEndMotionPath.f61y - this.mStartMotionPath.f61y;
