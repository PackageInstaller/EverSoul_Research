...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i5 = (int) (findPreviousPosition.f41x * i);
                i10 = i16;
                i9 = i2;
                i6 = (int) (findPreviousPosition.f42y * i9);
            ...
            if (findNextPosition != null) {
                int i22 = (int) (findNextPosition.f41x * i);
                int i23 = (int) (findNextPosition.f42y * i9);
    ...
    public boolean setValue(String str, CLElement cLElement) throws CLParsingException {
        ...
        switch (str.hashCode()) {
            ...
            case -1383228885:
                ...
                break;
            case -1349088399:
                if (str.equals(Constants.VALIDATION_CUSTOM)) {
                    c = 2;
                    break;
                }
                break;
    ...
    void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + CertificateUtil.DELIMITER + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + StringUtils.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
