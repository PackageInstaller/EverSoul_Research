...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f19id == -1 || solverVariable.f19id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f19id] == null) {
                if (solverVariable.f19id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f19id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f19id = i2;
    ...
    */
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f19id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f19id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f19id] = true;
            }
            if (pivotCandidate != null) {
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i = 0; i < this.mNumRows; i++) {
            str = (str + this.mRows[i]) + StringUtils.f1524LF;
        }
        System.out.println(str + this.mGoal + StringUtils.f1524LF);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public void displayReadableRows() {
        displaySolverVariables();
        String str = " num vars " + this.mVariablesID + StringUtils.f1524LF;
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + StringUtils.f1524LF;
            }
        }
        String str2 = str + StringUtils.f1524LF;
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i2 + "] => " + solverVariable2 + " = " + this.mCache.mIndexedVariables[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + StringUtils.f1524LF;
            }
        }
        String str3 = str2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str3 = str3 + "Goal: " + this.mGoal + StringUtils.f1524LF;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i].toReadableString()) + StringUtils.f1524LF;
            }
        }
        System.out.println(str + this.mGoal + StringUtils.f1524LF);
    }
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f19id) {
