...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01821 {
        ...
        static final /* synthetic */ int[] f52x56910102;
        ...
        static {
            ...
            try {
                f52x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        float f2;
        int i;
        int i2 = C01821.f52x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {
