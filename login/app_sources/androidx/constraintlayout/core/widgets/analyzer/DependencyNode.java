...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.run.widget.getDebugName() + CertificateUtil.DELIMITER + this.type + "(" + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.targets.size() + ":d=" + this.dependencies.size() + ">";
    }
