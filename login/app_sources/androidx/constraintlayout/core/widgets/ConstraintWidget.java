...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, ServerConstants.SIZE, i, Integer.MIN_VALUE);
        serializeAttribute(sb, Base2ndPWViewData.KEY_MIN, i2, 0);
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + StringUtils.SPACE : "") + (this.mDebugName != null ? "id: " + this.mDebugName + StringUtils.SPACE : "") + "(" + this.f44mX + ", " + this.f45mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
    ...
    public int getX() {
        ...
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f44mX;
        }
        return this.f44mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f45mY;
        }
        return this.f45mY;
    }
    ...
    protected int getRootX() {
        return this.f44mX + this.mOffsetX;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    protected int getRootY() {
        return this.f45mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01791.f46x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C01791.f46x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARN: Removed duplicated region for block: B:300:0x00ac  */
    ...
    */
    ...
    static /* synthetic */ class C01791 {
        ...
        static {
            ...
            try {
                f47x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f47x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f46x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f46x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f44mX = constraintWidget.f44mX;
        this.f45mY = constraintWidget.f45mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append(StringUtils.f1524LF);
        sb.append("    actualLeft:" + this.f44mX);
        sb.append(StringUtils.f1524LF);
        sb.append("    actualTop:" + this.f45mY);
        sb.append(StringUtils.f1524LF);
