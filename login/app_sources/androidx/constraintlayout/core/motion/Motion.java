...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f24x;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getStartY() {
        return this.mStartMotionPath.f25y;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getFinalX() {
        return this.mEndMotionPath.f24x;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public float getFinalY() {
        return this.mEndMotionPath.f25y;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f24x;
        floatRect.top = this.mStartMotionPath.f25y;
        ...
        floatRect2.left = this.mEndMotionPath.f24x;
        floatRect2.top = this.mEndMotionPath.f25y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f24x - this.mStartMotionPath.f24x;
        float f4 = this.mEndMotionPath.f25y - this.mStartMotionPath.f25y;
        float f5 = this.mStartMotionPath.f24x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f25y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                if (motionPathsArr[i17].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        ...
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, size, motionPathsArr[i17].getCustomDataCount(str8));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f24x;
                dArr6[i18][1] = motionPathsArr[i18].f25y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f24x + " y: " + this.mStartMotionPath.f25y + " end: x: " + this.mEndMotionPath.f24x + " y: " + this.mEndMotionPath.f25y;
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) Easing.this.getDiff(this.f21mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f6 = this.mStartMotionPath.f24x + ((this.mEndMotionPath.f24x - this.mStartMotionPath.f24x) * f5) + 0.5f;
            float f7 = this.mStartMotionPath.f25y + ((this.mEndMotionPath.f25y - this.mStartMotionPath.f25y) * f5) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f24x - this.mStartMotionPath.f24x;
        float f6 = this.mEndMotionPath.f25y - this.mStartMotionPath.f25y;
