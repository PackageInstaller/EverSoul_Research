...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2 = ((str + " ===== " + this.mType + StringUtils.f1524LF) + str + (this.mBackwards ? "backwards" : "forward ") + " time = " + f + "  stages " + this.mNumberOfStages + StringUtils.f1524LF) + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + StringUtils.f1524LF;
        if (this.mNumberOfStages > 1) {
            str2 = str2 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + StringUtils.f1524LF;
        }
        if (this.mNumberOfStages > 2) {
            str2 = str2 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + StringUtils.f1524LF;
        }
