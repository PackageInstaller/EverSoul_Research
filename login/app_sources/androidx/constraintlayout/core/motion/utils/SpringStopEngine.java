...
public class SpringStopEngine implements StopEngine {
    ...
    void log(String str) {
        ...
        System.out.println((".(" + stackTraceElement.getFileName() + CertificateUtil.DELIMITER + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "() ") + str);
    }
    ...
    public float getAcceleration() {
        return ((float) (((-this.mStiffness) * (this.mPos - this.mTargetPos)) - (this.mDamping * this.f40mV))) / this.mMass;
    }
