    ...
    */
    static void suppressLayout(android.view.ViewGroup r5, boolean r6) {
        ...
        L39:
            android.animation.LayoutTransition r0 = androidx.transition.ViewGroupUtilsApi14.sEmptyLayoutTransition
            if (r6 == r0) goto L42
            int r0 = androidx.transition.C0632R.id.transition_layout_save
            r5.setTag(r0, r6)
        L42:
        ...
        L7f:
            ...
            r5.requestLayout()
        L84:
            int r6 = androidx.transition.C0632R.id.transition_layout_save
    ...
    private static void cancelLayoutTransition(LayoutTransition layoutTransition) {
        if (!sCancelMethodFetched) {
            try {
                Method declaredMethod = LayoutTransition.class.getDeclaredMethod(Base2ndPWViewData.KEY_CANCEL, new Class[0]);
