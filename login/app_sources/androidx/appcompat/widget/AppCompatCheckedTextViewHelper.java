    ...
    */
    void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0047R.styleable.CheckedTextView
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0047R.styleable.CheckedTextView
            ...
            int r11 = androidx.appcompat.C0047R.styleable.CheckedTextView_checkMarkCompat     // Catch: java.lang.Throwable -> L8e
        ...
        L3f:
            if (r11 != 0) goto L5e
            int r11 = androidx.appcompat.C0047R.styleable.CheckedTextView_android_checkMark     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L5e
            int r11 = androidx.appcompat.C0047R.styleable.CheckedTextView_android_checkMark     // Catch: java.lang.Throwable -> L8e
            int r11 = r0.getResourceId(r11, r2)     // Catch: java.lang.Throwable -> L8e
        ...
        L5e:
            int r11 = androidx.appcompat.C0047R.styleable.CheckedTextView_checkMarkTint     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L71
            android.widget.CheckedTextView r11 = r10.mView     // Catch: java.lang.Throwable -> L8e
            int r12 = androidx.appcompat.C0047R.styleable.CheckedTextView_checkMarkTint     // Catch: java.lang.Throwable -> L8e
        ...
        L71:
            int r11 = androidx.appcompat.C0047R.styleable.CheckedTextView_checkMarkTintMode     // Catch: java.lang.Throwable -> L8e
            boolean r11 = r0.hasValue(r11)     // Catch: java.lang.Throwable -> L8e
            if (r11 == 0) goto L8a
            android.widget.CheckedTextView r11 = r10.mView     // Catch: java.lang.Throwable -> L8e
            int r12 = androidx.appcompat.C0047R.styleable.CheckedTextView_checkMarkTintMode     // Catch: java.lang.Throwable -> L8e
            r1 = -1
