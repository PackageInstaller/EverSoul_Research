...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0047R.attr.popupMenuStyle, 0);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0047R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0047R.dimen.abc_cascading_menus_min_smallest_width)) {
