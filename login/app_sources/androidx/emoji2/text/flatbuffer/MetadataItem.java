...
public final class MetadataItem extends Table {
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f125bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public short sdkAdded() {
        ...
        if (__offset != 0) {
            return this.f125bb.getShort(__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f125bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f125bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(MetadataItem.__indirect(__element(i), this.f119bb), this.f119bb);
        }
    }
}
