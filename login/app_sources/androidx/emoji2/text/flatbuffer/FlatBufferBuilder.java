...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f120bb = byteBuffer;
            byteBuffer.clear();
            this.f120bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f120bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f120bb.capacity();
    }
    ...
    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public int offset() {
        return this.f120bb.capacity() - this.space;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f120bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f120bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f120bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f120bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f120bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f120bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f120bb.getShort(capacity);
            if (s == this.f120bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f120bb.getShort(capacity + i7) != this.f120bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f120bb.capacity() - offset;
            this.space = capacity2;
            this.f120bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f120bb.capacity() - i;
        if (!(this.f120bb.getShort((capacity - this.f120bb.getInt(capacity)) + i2) != 0)) {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f120bb.capacity() - this.space);
        }
        this.f120bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f120bb.position(i);
        this.f120bb.get(bArr);
        return bArr;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f120bb.capacity() - this.space);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f120bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f120bb.capacity());
