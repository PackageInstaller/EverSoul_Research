...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f116X = new ViewProperty("x") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
            view.setX(f);
    ...
    /* renamed from: Y */
    public static final ViewProperty f117Y = new ViewProperty(AgreementService.VALUE_YES) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.10
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
            view.setY(f);
    ...
    /* renamed from: Z */
    public static final ViewProperty f118Z = new ViewProperty("z") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.11
        /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
