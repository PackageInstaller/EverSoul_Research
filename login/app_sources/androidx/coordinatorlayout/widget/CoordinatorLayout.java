...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0208R.styleable.CoordinatorLayout, 0, C0208R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0208R.styleable.CoordinatorLayout, i, 0);
        }
