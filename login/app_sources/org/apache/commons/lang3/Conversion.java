...
public class Conversion {
    ...
    public static int hexDigitToInt(char c) {
        ...
        throw new IllegalArgumentException(y.٬ݯح׭٩(575974110) + c + y.ٴسسݬߨ(1392996306));
    }
    ...
    */
    public static boolean[] hexDigitToBinary(char r3) {
        ...
        L9:
            ...
            r2 = 575974110(0x2254aade, float:2.8821814E-18)
            java.lang.String r2 = com.liapp.y.٬ݯح׭٩(r2)
            r1.<init>(r2)
            java.lang.StringBuilder r3 = r1.append(r3)
            r1 = 1392996306(0x53076fd2, float:5.816966E11)
    ...
    */
    ...
    public static char binaryToHexDigitMsb0_4bits(boolean[] zArr, int i) {
        if (zArr.length > 8) {
            throw new IllegalArgumentException(y.ݮڮֲڭܩ(-628925884) + zArr.length);
        }
        if (zArr.length - i >= 4) {
        ...
        throw new IllegalArgumentException(y.ٲٴݴ״ٰ(1781691320) + zArr.length + y.٬ݯح׭٩(575973774) + i);
    }
    ...
    public static char intToHexDigit(int i) {
        ...
        throw new IllegalArgumentException(y.ۮڭڭܬި(862126443) + i);
    }
    ...
    public static byte[] uuidToByteArray(UUID uuid, byte[] bArr, int i, int i2) {
        ...
        if (i2 > 16) {
            throw new IllegalArgumentException(y.ݬֲ֮ܲت(1512981023));
        }
