...
public class ArrayUtils {
    ...
    public static String toString(Object obj) {
        return toString(obj, y.֬ڱܱײٮ(-1159242071));
    }
    ...
    public static Map<Object, Object> toMap(Object[] objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            ...
            if (obj instanceof Map.Entry) {
                ...
                String str = y.ݮڮֲڭܩ(-628935484);
                String str2 = y.ٲٴݴ״ٰ(1781669800);
                if (z) {
                    Object[] objArr2 = (Object[]) obj;
                    if (objArr2.length < 2) {
                        throw new IllegalArgumentException(str2 + i + str + obj + y.دײܮڳܯ(2051933005));
                    }
                    hashMap.put(objArr2[0], objArr2[1]);
                } else {
                    throw new IllegalArgumentException(str2 + i + str + obj + y.ۮڭڭܬި(862153491));
                }
            }
        }
        return hashMap;
    ...
    public static <T> T[] addAll(T[] tArr, T... tArr2) {
        ...
        try {
            ...
            if (!componentType.isAssignableFrom(componentType2)) {
                throw new IllegalArgumentException(y.֬ڱܱײٮ(-1159243247) + componentType2.getName() + y.ۮڭڭܬި(862154387) + componentType.getName(), e);
            }
            throw e;
        }
    }
    ...
    private static Object add(Object obj, int i, Object obj2, Class<?> cls) {
        String str = y.ٲٴݴ״ٰ(1781668336);
        if (obj == null) {
            if (i != 0) {
                throw new IndexOutOfBoundsException(str + i + ", Length: 0");
            }
        ...
        int length = Array.getLength(obj);
        if (i > length || i < 0) {
            throw new IndexOutOfBoundsException(str + i + ", Length: " + length);
        }
    ...
    private static Object remove(Object obj, int i) {
        ...
        if (i < 0 || i >= length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + length);
        }
        int i2 = length - 1;
    ...
    static Object removeAll(Object obj, int... iArr) {
        ...
        if (isNotEmpty(clone)) {
            ...
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i2 + y.ݬֲ֮ܲت(1512975279) + length);
        }
        i = 0;
        int i4 = length - i;
    ...
    public static boolean[] insert(int i, boolean[] zArr, boolean... zArr2) {
        ...
        if (i < 0 || i > zArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + zArr.length);
        }
        boolean[] zArr3 = new boolean[zArr.length + zArr2.length];
    ...
    public static byte[] insert(int i, byte[] bArr, byte... bArr2) {
        ...
        if (i < 0 || i > bArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + bArr.length);
        }
        byte[] bArr3 = new byte[bArr.length + bArr2.length];
    ...
    public static char[] insert(int i, char[] cArr, char... cArr2) {
        ...
        if (i < 0 || i > cArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + cArr.length);
        }
        char[] cArr3 = new char[cArr.length + cArr2.length];
    ...
    public static double[] insert(int i, double[] dArr, double... dArr2) {
        ...
        if (i < 0 || i > dArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + dArr.length);
        }
        double[] dArr3 = new double[dArr.length + dArr2.length];
    ...
    public static float[] insert(int i, float[] fArr, float... fArr2) {
        ...
        if (i < 0 || i > fArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + fArr.length);
        }
        float[] fArr3 = new float[fArr.length + fArr2.length];
    ...
    public static int[] insert(int i, int[] iArr, int... iArr2) {
        ...
        if (i < 0 || i > iArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + iArr.length);
        }
        int[] iArr3 = new int[iArr.length + iArr2.length];
    ...
    public static long[] insert(int i, long[] jArr, long... jArr2) {
        ...
        if (i < 0 || i > jArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + jArr.length);
        }
        long[] jArr3 = new long[jArr.length + jArr2.length];
    ...
    public static short[] insert(int i, short[] sArr, short... sArr2) {
        ...
        if (i < 0 || i > sArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + sArr.length);
        }
        short[] sArr3 = new short[sArr.length + sArr2.length];
    ...
    public static <T> T[] insert(int i, T[] tArr, T... tArr2) {
        ...
        if (i < 0 || i > tArr.length) {
            throw new IndexOutOfBoundsException(y.ٲٴݴ״ٰ(1781668336) + i + y.ݬֲ֮ܲت(1512975279) + tArr.length);
        }
