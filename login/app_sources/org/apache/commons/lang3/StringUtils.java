...
public class StringUtils {
    ...
    /* renamed from: CR */
    public static final String f1523CR = "\r";
    public static final String EMPTY = "";
    public static final int INDEX_NOT_FOUND = -1;

    /* renamed from: LF */
    public static final String f1524LF = "\n";
    ...
    public static String stripAccents(String str) {
        ...
        Pattern compile = Pattern.compile(y.ݬֲ֮ܲت(1512991295));
    ...
    public static String join(byte[] bArr, char c, int i, int i2) {
        ...
        for (int i4 = i; i4 < i2; i4++) {
            ...
            newStringBuilder.append((int) bArr[i4]);
        }
        return newStringBuilder.toString();
    }
    ...
    public static String join(short[] sArr, char c, int i, int i2) {
        ...
        for (int i4 = i; i4 < i2; i4++) {
            ...
            newStringBuilder.append((int) sArr[i4]);
        }
        return newStringBuilder.toString();
    }
    ...
    public static String abbreviate(String str, int i) {
        return abbreviate(str, y.دײܮڳܯ(2051950045), 0, i);
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    public static String abbreviate(String str, int i, int i2) {
        return abbreviate(str, y.دײܮڳܯ(2051950045), i, i2);
    }
    ...
    public static int getLevenshteinDistance(CharSequence charSequence, CharSequence charSequence2, int i) {
        ...
        if (charSequence == null || charSequence2 == null) {
            throw new IllegalArgumentException(y.ݬֲ֮ܲت(1512991567));
        }
        if (i < 0) {
            throw new IllegalArgumentException(y.٬ݯح׭٩(575964134));
        }
        int length = charSequence.length();
        int length2 = charSequence2.length();
        if (length == 0) {
    ...
    public static String normalizeSpace(String str) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (Character.isWhitespace(charAt)) {
                if (i2 == 0 && !z) {
                    cArr[i] = y.دײܮڳܯ(2051829469).charAt(0);
                    i++;
                }
                i2++;
            } else {
