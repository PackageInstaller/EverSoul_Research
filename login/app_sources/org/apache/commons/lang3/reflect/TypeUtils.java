...
public class TypeUtils {
    ...
    private static boolean isAssignable(Type type, Type type2, Map<TypeVariable<?>, Type> map) {
        ...
        throw new IllegalStateException(y.֬ڱܱײٮ(-1159695679) + type2);
    }
    ...
    private static boolean isAssignable(Type type, Class<?> cls) {
        ...
        throw new IllegalStateException(y.֬ڱܱײٮ(-1159695679) + type);
    }
    ...
    private static Type substituteTypeVariables(Type type, Map<TypeVariable<?>, Type> map) {
        ...
        throw new IllegalArgumentException(y.دײܮڳܯ(2051613565) + type);
    }
    ...
    public static Map<TypeVariable<?>, Type> determineTypeArguments(Class<?> cls, ParameterizedType parameterizedType) {
        Validate.notNull(cls, y.ݮڮֲڭܩ(-628824924), new Object[0]);
        Validate.notNull(parameterizedType, y.ٲٴݴ״ٰ(1781911112), new Object[0]);
        Class<?> rawType = getRawType(parameterizedType);
        ...
        if (cls2.isInterface()) {
            ...
            for (Type type2 : cls.getGenericInterfaces()) {
                if (type2 instanceof ParameterizedType) {
                    ...
                    throw new IllegalStateException(y.֬ڱܱײٮ(-1159688567) + type2);
                }
    ...
    public static Type[] normalizeUpperBounds(Type[] typeArr) {
        boolean z;
        Validate.notNull(typeArr, y.دײܮڳܯ(2051615397), new Object[0]);
        if (typeArr.length < 2) {
            return typeArr;
        }
    ...
    public static Type[] getImplicitBounds(TypeVariable<?> typeVariable) {
        Validate.notNull(typeVariable, y.֬ڱܱײٮ(-1159696335), new Object[0]);
    ...
    public static Type[] getImplicitUpperBounds(WildcardType wildcardType) {
        Validate.notNull(wildcardType, y.ݬֲ֮ܲت(1512637991), new Object[0]);
    ...
    public static boolean typesSatisfyVariables(Map<TypeVariable<?>, Type> map) {
        Validate.notNull(map, y.ۮڭڭܬި(862210659), new Object[0]);
    ...
    private static Class<?> getRawType(ParameterizedType parameterizedType) {
        ...
        if (!(rawType instanceof Class)) {
            throw new IllegalStateException(y.֬ڱܱײٮ(-1159695535) + rawType);
        }
    ...
    public static Class<?> getRawType(Type type, Type type2) {
        ...
        if (!(type instanceof TypeVariable)) {
            ...
            throw new IllegalArgumentException(y.ݬֲ֮ܲت(1512637671) + type);
        }
        if (type2 == null) {
            return null;
        }
    ...
    public static final ParameterizedType parameterize(Class<?> cls, Map<TypeVariable<?>, Type> map) {
        Validate.notNull(cls, y.ۮڭڭܬި(862208827), new Object[0]);
        Validate.notNull(map, y.دײܮڳܯ(2051614933), new Object[0]);
    ...
    public static final ParameterizedType parameterizeWithOwner(Type type, Class<?> cls, Type... typeArr) {
        ...
        if (cls.getEnclosingClass() == null) {
            Validate.isTrue(type == null, y.٬ݯح׭٩(575926110), cls);
            type = null;
        } else if (type == null) {
            type = cls.getEnclosingClass();
        } else {
            Validate.isTrue(isAssignable(type, cls.getEnclosingClass()), y.ݬֲ֮ܲت(1512640287), type, cls);
        }
        Validate.noNullElements(typeArr, y.ݬֲ֮ܲت(1512640103), new Object[0]);
        Validate.isTrue(cls.getTypeParameters().length == typeArr.length, y.ٲٴݴ״ٰ(1781873128), Integer.valueOf(cls.getTypeParameters().length), Integer.valueOf(typeArr.length));
    ...
    private static Type[] extractTypeArgumentsFrom(Map<TypeVariable<?>, Type> map, TypeVariable<?>[] typeVariableArr) {
        ...
        while (i < length) {
            ...
            Validate.isTrue(map.containsKey(typeVariable), y.٬ݯح׭٩(575870406), toString((Type) typeVariable));
    ...
    public static GenericArrayType genericArrayType(Type type) {
        return new GenericArrayTypeImpl((Type) Validate.notNull(type, y.ݬֲ֮ܲت(1512700263), new Object[0]));
    }
    ...
    public static String toLongString(TypeVariable<?> typeVariable) {
        Validate.notNull(typeVariable, y.دײܮڳܯ(2051612701), new Object[0]);
    ...
    private static String classToString(Class<?> cls) {
        if (cls.isArray()) {
            return toString((Type) cls.getComponentType()) + y.ۮڭڭܬި(862157459);
        }
        StringBuilder sb = new StringBuilder();
        if (cls.getEnclosingClass() != null) {
        ...
        if (cls.getTypeParameters().length > 0) {
            ...
            appendAllTo(sb, y.ݬֲ֮ܲت(1513068719), cls.getTypeParameters());
    ...
    private static String typeVariableToString(TypeVariable<?> typeVariable) {
        ...
        if (bounds.length > 0 && (bounds.length != 1 || !Object.class.equals(bounds[0]))) {
            sb.append(y.ۮڭڭܬި(862211043));
            appendAllTo(sb, y.ٴسسݬߨ(1392518002), typeVariable.getBounds());
        }
        return sb.toString();
    }
    ...
    private static String parameterizedTypeToString(ParameterizedType parameterizedType) {
        ...
        if (findRecursiveTypes.length > 0) {
            ...
            appendAllTo(sb.append(Typography.less), y.ݬֲ֮ܲت(1513068719), parameterizedType.getActualTypeArguments()).append(Typography.greater);
        }
        return sb.toString();
    }
    ...
    private static void appendRecursiveTypes(StringBuilder sb, int[] iArr, Type[] typeArr) {
        ...
        while (true) {
            ...
            str = y.ݬֲ֮ܲت(1513068719);
            if (i >= length) {
                break;
            }
            appendAllTo(sb.append(Typography.less), str, typeArr[i].toString()).append(Typography.greater);
            i++;
        }
        Type[] typeArr2 = (Type[]) ArrayUtils.removeAll((Object[]) typeArr, iArr);
        if (typeArr2.length > 0) {
            appendAllTo(sb.append(Typography.less), str, typeArr2).append(Typography.greater);
        }
    }
    ...
    private static String wildcardTypeToString(WildcardType wildcardType) {
        ...
        String str = y.ٴسسݬߨ(1392518002);
        if (length > 1 || (lowerBounds.length == 1 && lowerBounds[0] != null)) {
            appendAllTo(append.append(" super "), str, lowerBounds);
        } else if (upperBounds.length > 1 || (upperBounds.length == 1 && !Object.class.equals(upperBounds[0]))) {
            appendAllTo(append.append(y.ۮڭڭܬި(862211043)), str, upperBounds);
        }
