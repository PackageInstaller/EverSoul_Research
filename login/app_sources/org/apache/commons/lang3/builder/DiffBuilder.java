...
public class DiffBuilder implements Builder<DiffResult> {
    ...
    public DiffBuilder(Object obj, Object obj2, ToStringStyle toStringStyle, boolean z) {
        boolean z2 = true;
        Validate.isTrue(obj != null, y.ۮڭڭܬި(862251331), new Object[0]);
        Validate.isTrue(obj2 != null, y.ݬֲ֮ܲت(1512680079), new Object[0]);
    ...
    public DiffBuilder append(String str, DiffResult diffResult) {
        validateFieldNameNotNull(str);
        Validate.isTrue(diffResult != null, y.دײܮڳܯ(2051637501), new Object[0]);
        if (this.objectsTriviallyEqual) {
            return this;
        }
        for (Diff<?> diff : diffResult.getDiffs()) {
            append(str + y.ݮڮֲڭܩ(-629059348) + diff.getFieldName(), diff.getLeft(), diff.getRight());
        }
        return this;
    }
    ...
    private void validateFieldNameNotNull(String str) {
        Validate.isTrue(str != null, y.ٴسسݬߨ(1392542186), new Object[0]);
    }
}
