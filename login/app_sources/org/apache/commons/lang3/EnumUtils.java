...
public class EnumUtils {
    ...
    public static <E extends Enum<E>> long generateBitVector(Class<E> cls, Iterable<? extends E> iterable) {
        ...
        while (it.hasNext()) {
            E next = it.next();
            Validate.isTrue(next != null, y.ݮڮֲڭܩ(-628928060), new Object[0]);
            j |= 1 << next.ordinal();
        }
        return j;
    }
    ...
    public static <E extends Enum<E>> long[] generateBitVectors(Class<E> cls, Iterable<? extends E> iterable) {
        ...
        while (true) {
            ...
            Validate.isTrue(z, y.ݮڮֲڭܩ(-628928060), new Object[0]);
            noneOf.add(next);
        }
    ...
    private static <E extends Enum<E>> Class<E> checkBitVectorable(Class<E> cls) {
        ...
        Validate.isTrue(enumArr.length <= 64, y.֬ڱܱײٮ(-1159251623), Integer.valueOf(enumArr.length), cls.getSimpleName(), 64);
        return cls;
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    private static <E extends Enum<E>> Class<E> asEnum(Class<E> cls) {
        Validate.notNull(cls, y.ٴسسݬߨ(1392994818), new Object[0]);
        Validate.isTrue(cls.isEnum(), y.ۮڭڭܬި(862126603), cls);
        return cls;
    }
}
