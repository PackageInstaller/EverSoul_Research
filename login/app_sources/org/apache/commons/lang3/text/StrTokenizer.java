...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    @Override // java.util.ListIterator, java.util.Iterator
    public void remove() {
        throw new UnsupportedOperationException(y.دײܮڳܯ(2051616789));
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    @Override // java.util.ListIterator
    public void set(String str) {
        throw new UnsupportedOperationException(y.֬ڱܱײٮ(-1159696879));
    }

    /* JADX WARN: Unreachable blocks removed: 1, instructions: 1 */
    @Override // java.util.ListIterator
    public void add(String str) {
        throw new UnsupportedOperationException(y.ݮڮֲڭܩ(-628881948));
    }
    ...
    public String toString() {
        return this.tokens == null ? y.٬ݯح׭٩(575928302) : y.ٴسسݬߨ(1392512186) + getTokenList();
    }
}
