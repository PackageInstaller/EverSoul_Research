...
public class ExtendedMessageFormat extends MessageFormat {
        ...
        while (parsePosition.getIndex() < str.length()) {
            ...
            if (c == '\'') {
                ...
                if (c == '{') {
                    ...
                    if (charArray[parsePosition.getIndex()] != '}') {
                        throw new IllegalArgumentException(y.دײܮڳܯ(2051620021) + index);
                    }
                }
    ...
    private int readArgumentIndex(String str, ParsePosition parsePosition) {
        ...
        if (z) {
            throw new IllegalArgumentException(y.ݮڮֲڭܩ(-628881100) + index + y.ݬֲ֮ܲت(1512932847) + str.substring(index, parsePosition.getIndex()));
        }
        throw new IllegalArgumentException(y.ۮڭڭܬި(862213411) + index);
    }
