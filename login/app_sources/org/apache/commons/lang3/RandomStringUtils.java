...
public class RandomStringUtils {
    ...
    public static String random(int i, int i2, int i3, boolean z, boolean z2, char[] cArr, Random random) {
        ...
        if (i2 == 0 && i3 == 0) {
            ...
            throw new IllegalArgumentException(str + i3 + ") must be greater than start (" + i2 + ")");
        }
        if (cArr == null && ((z2 && i3 <= 48) || (z && i3 <= 65))) {
            throw new IllegalArgumentException(str + i3 + ") must be greater then (48) for generating digits or greater then (65) for generating letters.");
        }
