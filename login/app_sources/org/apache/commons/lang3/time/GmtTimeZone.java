...
class GmtTimeZone extends TimeZone {
    ...
    GmtTimeZone(boolean z, int i, int i2) {
        ...
        this.offset = z ? -i3 : i3;
        this.zoneId = twoDigits(twoDigits(new StringBuilder(9).append(y.֬ڱܱײٮ(-1159379423)).append(z ? '-' : '+'), i).append(':'), i2).toString();
    }
    ...
    public String toString() {
        return y.دײܮڳܯ(2051580301) + this.zoneId + y.ݬֲ֮ܲت(1512609551) + this.offset + ']';
    }
