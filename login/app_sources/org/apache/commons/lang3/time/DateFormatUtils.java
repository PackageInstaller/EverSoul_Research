...
public class DateFormatUtils {
    ...
    static {
        FastDateFormat fastDateFormat = FastDateFormat.getInstance(y.٬ݯح׭٩(575898406));
        ISO_8601_EXTENDED_DATETIME_FORMAT = fastDateFormat;
        ISO_DATETIME_FORMAT = fastDateFormat;
        FastDateFormat fastDateFormat2 = FastDateFormat.getInstance(y.ݮڮֲڭܩ(-628853860));
        ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT = fastDateFormat2;
        ISO_DATETIME_TIME_ZONE_FORMAT = fastDateFormat2;
        FastDateFormat fastDateFormat3 = FastDateFormat.getInstance(y.٬ݯح׭٩(575898790));
        ISO_8601_EXTENDED_DATE_FORMAT = fastDateFormat3;
        ISO_DATE_FORMAT = fastDateFormat3;
        ISO_DATE_TIME_ZONE_FORMAT = FastDateFormat.getInstance(y.ٴسسݬߨ(1392525482));
        ISO_TIME_FORMAT = FastDateFormat.getInstance(y.دײܮڳܯ(2051621653));
        ISO_TIME_TIME_ZONE_FORMAT = FastDateFormat.getInstance(y.ٲٴݴ״ٰ(1781882584));
        FastDateFormat fastDateFormat4 = FastDateFormat.getInstance(y.֬ڱܱײٮ(-1159716999));
        ISO_8601_EXTENDED_TIME_FORMAT = fastDateFormat4;
        ISO_TIME_NO_T_FORMAT = fastDateFormat4;
        FastDateFormat fastDateFormat5 = FastDateFormat.getInstance(y.ݮڮֲڭܩ(-628853052));
        ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT = fastDateFormat5;
        ISO_TIME_NO_T_TIME_ZONE_FORMAT = fastDateFormat5;
        SMTP_DATETIME_FORMAT = FastDateFormat.getInstance(y.دײܮڳܯ(2051620997), Locale.US);
    }
