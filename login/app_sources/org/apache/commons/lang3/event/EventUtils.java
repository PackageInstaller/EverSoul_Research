...
public class EventUtils {
    ...
    public static <L> void addEventListener(Object obj, Class<L> cls, L l) {
        ...
        String str2 = y.٬ݯح׭٩(575879214);
        String str3 = y.ۮڭڭܬި(862229595);
        try {
            MethodUtils.invokeMethod(obj, y.ٴسسݬߨ(1392573938) + cls.getSimpleName(), l);
        } catch (IllegalAccessException unused) {
            throw new IllegalArgumentException(str3 + obj.getClass().getName() + y.ۮڭڭܬި(862229731) + cls.getSimpleName() + str2 + cls.getName() + str);
        } catch (NoSuchMethodException unused2) {
            throw new IllegalArgumentException(str3 + obj.getClass().getName() + y.ݬֲ֮ܲت(1512691071) + cls.getSimpleName() + str2 + cls.getName() + str);
