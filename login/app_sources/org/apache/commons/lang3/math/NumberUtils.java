...
public class NumberUtils {
    ...
    */
    ...
    public static BigInteger createBigInteger(String str) {
        ...
        boolean startsWith = str.startsWith(y.ٴسسݬߨ(1392558282));
        int i2 = 16;
        if (str.startsWith(y.دײܮڳܯ(2051829341), startsWith ? 1 : 0) || str.startsWith(y.ݮڮֲڭܩ(-628820740), startsWith ? 1 : 0)) {
            i = (startsWith ? 1 : 0) + 2;
        } else if (str.startsWith(y.دײܮڳܯ(2051964157), startsWith ? 1 : 0)) {
            i = (startsWith ? 1 : 0) + 1;
        } else {
            if (str.startsWith(y.دײܮڳܯ(2051900013), startsWith ? 1 : 0)) {
    ...
    public static BigDecimal createBigDecimal(String str) {
        ...
        if (StringUtils.isBlank(str)) {
            throw new NumberFormatException(y.٬ݯح׭٩(575865686));
        }
        if (str.trim().startsWith(y.ٲٴݴ״ٰ(1781913960))) {
            throw new NumberFormatException(str + y.ٲٴݴ״ٰ(1781913992));
        }
    ...
    private static void validateArray(Object obj) {
        Validate.isTrue(obj != null, y.֬ڱܱײٮ(-1159249767), new Object[0]);
