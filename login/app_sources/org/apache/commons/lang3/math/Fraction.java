...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    */
    public static org.apache.commons.lang3.math.Fraction getFraction(double r21) {
        ...
        L7c:
            ...
            r1 = 862231491(0x33649bc3, float:5.322705E-8)
            java.lang.String r1 = com.liapp.y.ۮڭڭܬި(r1)
            r0.<init>(r1)
            throw r0
        L89:
            java.lang.ArithmeticException r0 = new java.lang.ArithmeticException
            r1 = 575866902(0x22530816, float:2.8600113E-18)
    ...
    public static Fraction getFraction(String str) {
        Validate.isTrue(str != null, y.ۮڭڭܬި(862234427), new Object[0]);
        if (str.indexOf(46) >= 0) {
        ...
        if (indexOf > 0) {
            ...
            if (indexOf2 < 0) {
                throw new NumberFormatException(y.֬ڱܱײٮ(-1159687223));
            }
    ...
    public Fraction invert() {
        int i = this.numerator;
        if (i == 0) {
            throw new ArithmeticException(y.֬ڱܱײٮ(-1159686415));
        }
        if (i == Integer.MIN_VALUE) {
            throw new ArithmeticException(y.ݬֲ֮ܲت(1512694055));
        }
        if (i < 0) {
    ...
    public Fraction negate() {
        int i = this.numerator;
        if (i == Integer.MIN_VALUE) {
            throw new ArithmeticException(y.دײܮڳܯ(2051655421));
        }
    ...
    */
    private static int greatestCommonDivisor(int r6, int r7) {
        /*
            r0 = 575868054(0x22530c96, float:2.8602495E-18)
    ...
    private Fraction addSub(Fraction fraction, boolean z) {
        Validate.isTrue(fraction != null, y.ۮڭڭܬި(862230731), new Object[0]);
        if (this.numerator == 0) {
    ...
    public Fraction divideBy(Fraction fraction) {
        Validate.isTrue(fraction != null, y.ۮڭڭܬި(862230731), new Object[0]);
        if (fraction.numerator == 0) {
            throw new ArithmeticException(y.ۮڭڭܬި(862232683));
        }
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = getNumerator() + y.ۮڭڭܬި(861981587) + getDenominator();
        }
    ...
    public String toProperString() {
        if (this.toProperString == null) {
            int i = this.numerator;
            if (i == 0) {
                this.toProperString = y.دײܮڳܯ(2051900013);
            } else {
                int i2 = this.denominator;
                if (i == i2) {
                    this.toProperString = y.ۮڭڭܬި(862235827);
                } else if (i == i2 * (-1)) {
                    this.toProperString = y.֬ڱܱײٮ(-1159685983);
                } else {
                    if (i > 0) {
                        i = -i;
                    }
                    ...
                    if (i < i3) {
                        ...
                        if (properNumerator == 0) {
                            ...
                            this.toProperString = getProperWhole() + y.دײܮڳܯ(2051829469) + properNumerator + str + getDenominator();
                        }
                    } else {
                        this.toProperString = getNumerator() + str + getDenominator();
                    }
                }
            }
        }
